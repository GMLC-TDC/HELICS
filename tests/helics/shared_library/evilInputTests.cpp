...
TEST(evil_creation_test,helicsCreateValueFederateFromConfig)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCreateValueFederateFromConfig(const char* configFile, &err);
    helicsErrorClear(&err);
    //auto res2=helicsCreateValueFederateFromConfig(const char* configFile, nullptr);
}
...
TEST(evil_creation_test,helicsCreateMessageFederate)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCreateMessageFederate(const char* fedName, helics_federate_info fi, &err);
    helicsErrorClear(&err);
...
TEST(evil_creation_test,helicsCreateMessageFederateFromConfig)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCreateMessageFederateFromConfig(const char* configFile, &err);
    helicsErrorClear(&err);
    //auto res2=helicsCreateMessageFederateFromConfig(const char* configFile, nullptr);
}
...
TEST(evil_creation_test,helicsCreateCombinationFederate)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCreateCombinationFederate(const char* fedName, helics_federate_info fi, &err);
    helicsErrorClear(&err);
    //auto res2=helicsCreateCombinationFederate(const char* fedName, helics_federate_info fi, nullptr);
}
...
TEST(evil_creation_test,helicsCreateCombinationFederateFromConfig)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCreateCombinationFederateFromConfig(const char* configFile, &err);
    helicsErrorClear(&err);
    //auto res2=helicsCreateCombinationFederateFromConfig(const char* configFile, nullptr);
}
...
TEST(evil_core_test,helicsCoreClone)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCoreClone(helics_core core, &err);
    helicsErrorClear(&err);
    //auto res2=helicsCoreClone(helics_core core, nullptr);
...
TEST(evil_core_test,helicsCoreIsValid)
{
    ...
    char rdata[256];
    helics_core evil_core=reinterpret_cast<helics_core>(rdata);
    //auto res1=helicsCoreIsValid(evil_core);
}
...
TEST(evil_core_test,helicsCoreWaitForDisconnect)
{
    ...
    auto err=helicsErrorInitialize();
    err.error_code=45;
    //auto res1=helicsCoreWaitForDisconnect(helics_core core, int msToWait, &err);
    helicsErrorClear(&err);
    //auto res2=helicsCoreWaitForDisconnect(helics_core core, int msToWait, nullptr);
    //auto res3=helicsCoreWaitForDisconnect(evil_core, int msToWait, &err);
}
