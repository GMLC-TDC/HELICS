...
static HelicsTime timeIterativeCall(HelicsTime time, HelicsIterationResult res, HelicsIterationRequest* req, void* userData)
{
    auto *fc=reinterpret_cast<std::function<HelicsTime(HelicsTime,HelicsIterationResult,HelicsIterationRequest *)> *>(userData);
...
static void timeReqEntry(HelicsTime time, HelicsTime requestTime, HelicsBool iterating, void* userData)
{
...
TEST_F(callback_federate_tests, timeStepsPeriodMax)
{
    ...
    std::function<void(HelicsTime,HelicsBool)> reqert=[&cb1](HelicsTime,HelicsBool) {
        ++cb1;
    };

    std::function<void(HelicsTime,HelicsTime,HelicsBool)> reqenter=[&cb2](HelicsTime,HelicsTime,HelicsBool) {
        ++cb2;
    };
...
TEST_F(callback_federate_tests, initException)
{
    ...
    std::function<void(int,const char *)> eHandle=[v = std::move(v)](int /*code*/, const char * message) {
