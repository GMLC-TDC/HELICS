...
TEST(misc_tests, misc_tests)
{
    ...
    helicsFederateInfoSetIntegerProperty(fedInfo1, HELICS_PROPERTY_INT_LOG_LEVEL, HELICS_LOG_LEVEL_WARNING, nullptr);
    ...
    auto broker3 = helicsCreateBroker("zmq", "broker3", "--federates 1 --loglevel warning", nullptr);
    ...
    helicsFederateInfoSetIntegerProperty(fedInfo2, HELICS_PROPERTY_INT_LOG_LEVEL, HELICS_LOG_LEVEL_WARNING, nullptr);
