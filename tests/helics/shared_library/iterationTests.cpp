...
BOOST_AUTO_TEST_CASE(time_iteration_test)
{
    ...
    auto comp =
        vFed1->requestTimeIterative(1.0, helics::helics_iteration_request::iterate_if_needed);
...
BOOST_AUTO_TEST_CASE(time_iteration_test_2fed)
{
    ...
    auto comp =
        vFed2->requestTimeIterative(1.0, helics::helics_iteration_request::iterate_if_needed);
...
BOOST_AUTO_TEST_CASE(test2fed_withSubPub)
{
    ...
    auto vFed2 = GetFederateAs<helics::ValueFederate>(1);
    // register the publications
    auto pub1 = helics::Publication(
        helics::GLOBAL, vFed1.get(), "pub1", helics::helics_type_t::helicsDouble);
...
BOOST_AUTO_TEST_CASE(test_iteration_counter)
{
    ...
    // register the publications
    auto pub1 =
        helics::Publication(helics::GLOBAL, vFed1.get(), "pub1", helics::helics_type_t::helicsInt);

    auto sub1 = helics::Subscription(vFed2.get(), "pub1");

    auto pub2 =
        helics::Publication(helics::GLOBAL, vFed2.get(), "pub2", helics::helics_type_t::helicsInt);
