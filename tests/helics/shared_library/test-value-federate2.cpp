 ...
 */
class vfed2_simple_type_tests : public ::testing::TestWithParam<const char *>, public FederateTestFixture
{
};
...
INSTANTIATE_TEST_SUITE_P (vfed_tests, vfed2_simple_type_tests, ::testing::ValuesIn (core_types_simple));
