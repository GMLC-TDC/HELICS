...
{
  runFederateTestString (GetParam (), "start", "inside of the functional relationship of helics", "I am a string");
}

TEST_P (vfed_type_tests, single_transfer_named_point)
{
  runFederateTestNamedPoint (GetParam (), "start", 5.3, "inside of the functional relationship of helics", 45.7823,
                             "I am a string", 0.0);
}
