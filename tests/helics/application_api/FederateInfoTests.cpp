...
{
    std::vector<std::string> args{ "constructor2", "--name", "f2", "--type", "zmq","--flags", "realtime,source_only" };
    char* argv[7];
...
TEST(federateInfo, constructor3)
{
    ...
    helics::FederateInfo f1{ "--name f3 --type ipc --flags realtime;source_only,-buffer_data --port=5000" };
