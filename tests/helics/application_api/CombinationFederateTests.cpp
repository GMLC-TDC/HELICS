...
class combofed_single_type_tests : public ::testing::TestWithParam<const char *>, public FederateTestFixture
{
};

class combofed_type_tests : public ::testing::TestWithParam<const char *>, public FederateTestFixture
{
};
...
INSTANTIATE_TEST_SUITE_P (combofed_tests, combofed_single_type_tests, ::testing::ValuesIn (core_types_simple));
...
class combofed_file_load_tests : public ::testing::TestWithParam<const char *>, public FederateTestFixture
{
};
...
INSTANTIATE_TEST_SUITE_P (combofed_tests, combofed_file_load_tests, ::testing::ValuesIn (combo_config_files));
