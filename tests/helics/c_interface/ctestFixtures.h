...
struct FederateTestFixture
{
    ...
    //    std::shared_ptr<helics::CoreBroker> AddBroker(const std::string &core_type_name, const std::string
    //    &initialization_string);
    //
    //    template<class FedType>
    //    void SetupSingleBrokerTest(std::string core_type_name, int count, helics::Time time_delta =
    //    helics::timeZero, std::string name_prefix = "fed")
    //    {
    ...
    //
    //    template<class FedType>
    //    std::vector<std::shared_ptr<FedType>> AddFederates(std::string core_type_name, int count,
    //    std::shared_ptr<helics::CoreBroker> broker, helics::Time time_delta = helics::timeZero, std::string
    //    name_prefix = "fed")
    //    {
