...
SWIGRUNTIME int
SWIG_Matlab_CallInterp (int nlhs, mxArray *plhs[], int nrhs, mxArray *prhs[], const char *functionName)
{
#ifdef HAVE_OCTAVE
...
SWIGRUNTIME mxArray *
SWIG_Matlab_CallInterpEx (int nlhs, mxArray *plhs[], int nrhs, mxArray *prhs[], const char *functionName)
{
#ifdef HAVE_OCTAVE
...
SWIGRUNTIME mxArray *SWIG_Matlab_NewPointerObj (void *ptr, swig_type_info *type, int flags)
{
  ...
  if (ex)
    mexErrMsgIdAndTxt ("SWIG:NewPointerObj", "Cannot create SwigRef instance");
  ...
  *(uint64_T *)mxGetData (pm_ptr) = (uint64_T)swig_ptr;
  if (!pm_ptr)
    mexErrMsgIdAndTxt ("SWIG:NewPointerObj", "mxCreateNumericMatrix failed");
  ...
  if (type->clientdata)
  {
    ...
    if (ex)
    {
      mexWarnMsgIdAndTxt ("SWIG:NewPointerObj", "NewPointerObj problem. creating SwigRef as opposed to %s",
                          matlab_classname);
    }
    else
    {
  ...
  *ptr = SWIG_TypeCast (tc, *ptr, &newmemory);
  if (newmemory == SWIG_CAST_NEW_MEMORY)
  {
    ...
    else
    {
      ...
      mexErrMsgIdAndTxt ("SWIG:ConvertPointerObj", "SWIG error in converting pointer for type %s. Bad typemap?",
                         type->name);
      return SWIG_ERROR;
    }
  }
...
SWIGRUNTIME swig_module_info *SWIG_Matlab_GetModule (void *SWIGUNUSEDPARM (clientdata))
{
  if (!saved_swig_module)
  {
    ...
    if (flag || !mem)
      mexErrMsgIdAndTxt ("SWIG:GetModule", "Cannot call SwigMem");
    ...
    if (mxGetNumberOfElements (mem) != 0)
    {
      ...
      mxArray *module =
        mxGetField (mem, 0, "swig_runtime_data_type_pointer" SWIG_RUNTIME_VERSION SWIG_TYPE_TABLE_NAME);
      if (module && mxGetNumberOfElements (module) == 1 && mxGetClassID (module) == mxUINT64_CLASS &&
          !mxIsComplex (module))
      {
...
SWIGRUNTIME void SWIG_Matlab_SetModule (swig_module_info *pointer)
{
  ...
  int flag = mexCallMATLAB (1, &mem, 0, 0, "SwigMem");
  if (flag || !mem)
    mexErrMsgIdAndTxt ("SWIG:SetModule", "Cannot call SwigMem");
  ...
  if (mxGetNumberOfElements (mem) == 0)
  {
    ...
    if (!mem)
      mexErrMsgIdAndTxt ("SWIG:SetModule", "mxCreateStructMatrix failed");
    mxArray *module = mxCreateNumericMatrix (1, 1, mxUINT64_CLASS, mxREAL);
    if (!module)
      mexErrMsgIdAndTxt ("SWIG:SetModule", "mxCreateNumericMatrix failed");
  ...
  else
  {
    ...
    if (fieldNum < 0)
      mexErrMsgIdAndTxt ("SWIG:SetModule", "Error adding field to SwigMem");
    mxArray *module = mxCreateNumericMatrix (1, 1, mxUINT64_CLASS, mxREAL);
    if (!module)
      mexErrMsgIdAndTxt ("SWIG:SetModule", "mxCreateNumericMatrix failed");
    *(uint64_T *)mxGetData (module) = (uint64_T)pointer;
...
SWIGINTERNINLINE mxArray *SWIG_From_int (int value) { return SWIG_From_long (value); }

SWIGINTERNINLINE mxArray *SWIG_From_double (double value) { return mxCreateDoubleScalar (value); }

SWIGINTERN int SWIG_AsVal_double (mxArray *pm, double *val)
{
  if (!mxIsDouble (pm) || mxGetNumberOfElements (pm) != 1)
...
{
  if (!mxIsChar (pm) || (mxGetNumberOfElements (pm) != 0 && mxGetM (pm) != 1))
    return SWIG_TypeError;
...
SWIGINTERNINLINE mxArray *SWIG_FromCharPtrAndSize (const char *carray, size_t size)
{
  ...
  if (!ret)
    mexErrMsgIdAndTxt ("SWIG:FromCharPtrAndSize", "mxCreateCharArray failed");
...
SWIGINTERN int SWIG_AsVal_long_SS_long (mxArray *pm, long long *val)
{
  ...
  case mxINT8_CLASS:
    if (val)
      *val = (long long)(*(int8_T *)mxGetData (pm));
    break;
  case mxUINT8_CLASS:
    if (val)
      *val = (long long)(*(uint8_T *)mxGetData (pm));
    break;
  case mxINT16_CLASS:
    if (val)
      *val = (long long)(*(int16_T *)mxGetData (pm));
    break;
  case mxUINT16_CLASS:
    if (val)
      *val = (long long)(*(uint16_T *)mxGetData (pm));
    break;
  case mxINT32_CLASS:
    if (val)
      *val = (long long)(*(int32_T *)mxGetData (pm));
    break;
  case mxUINT32_CLASS:
    if (val)
      *val = (long long)(*(uint32_T *)mxGetData (pm));
    break;
  case mxINT64_CLASS:
    if (val)
      *val = (long long)(*(int64_T *)mxGetData (pm));
    break;
  case mxUINT64_CLASS:
    if (val)
      *val = (long long)(*(uint64_T *)mxGetData (pm));
    break;
  case mxDOUBLE_CLASS:
  {
...
SWIGINTERN int SWIG_AsVal_long (mxArray *pm, long *val)
{
  ...
  case mxINT8_CLASS:
    if (val)
      *val = (long)(*(int8_T *)mxGetData (pm));
    break;
  case mxUINT8_CLASS:
    if (val)
      *val = (long)(*(uint8_T *)mxGetData (pm));
    break;
  case mxINT16_CLASS:
    if (val)
      *val = (long)(*(int16_T *)mxGetData (pm));
    break;
  case mxUINT16_CLASS:
    if (val)
      *val = (long)(*(uint16_T *)mxGetData (pm));
    break;
  case mxINT32_CLASS:
    if (val)
      *val = (long)(*(int32_T *)mxGetData (pm));
    break;
  case mxUINT32_CLASS:
    if (val)
      *val = (long)(*(uint32_T *)mxGetData (pm));
    break;
  case mxINT64_CLASS:
    if (val)
      *val = (long)(*(int64_T *)mxGetData (pm));
    break;
  case mxUINT64_CLASS:
    if (val)
      *val = (long)(*(uint64_T *)mxGetData (pm));
    break;
  case mxDOUBLE_CLASS:
  {
    double v = mxGetScalar (pm);
...
SWIGINTERNINLINE mxArray *SWIG_From_char (char c) { return SWIG_FromCharPtrAndSize (&c, 1); }
...
int _wrap_helics_message_messageID_get (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  _out = SWIG_NewPointerObj ((new int32_t (static_cast<const int32_t &> (result))), SWIGTYPE_p_int32_t,
                             SWIG_POINTER_OWN | 0);
  if (_out)
    --resc, *resv++ = _out;
  return 0;
...
int _wrap_helics_message_flags_get (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  arg1 = reinterpret_cast<helics_message *> (argp1);
  result = ((arg1)->flags);
  _out = SWIG_NewPointerObj ((new int16_t (static_cast<const int16_t &> (result))), SWIGTYPE_p_int16_t,
                             SWIG_POINTER_OWN | 0);
  if (_out)
    --resc, *resv++ = _out;
  return 0;
...
int _wrap_helics_message_original_source_set (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  if (arg2)
  {
    ...
    arg1->original_source =
      (char const *)reinterpret_cast<char *> (memcpy ((new char[size]), arg2, sizeof (char) * (size)));
  }
  else
  {
...
int _wrap_helicsFederateRequestTimeIterative (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    if (--resc >= 0)
      *resv++ = SWIG_From_int ((*arg4));
  }
  else
  {
    int new_flags = SWIG_IsNewObj (res4) ? (SWIG_POINTER_OWN | 0) : 0;
    if (--resc >= 0)
      *resv++ = SWIG_NewPointerObj ((void *)(arg4), SWIGTYPE_p_helics_iteration_result, new_flags);
  }
  {
    if (arg5->error_code != helics_ok)
    {
...
int _wrap_helicsFederateRequestTimeIterativeComplete (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    if (--resc >= 0)
      *resv++ = SWIG_From_int ((*arg2));
  }
  else
  {
    int new_flags = SWIG_IsNewObj (res2) ? (SWIG_POINTER_OWN | 0) : 0;
    if (--resc >= 0)
      *resv++ = SWIG_NewPointerObj ((void *)(arg2), SWIGTYPE_p_helics_iteration_result, new_flags);
  }
  {
    if (arg3->error_code != helics_ok)
    {
...
int _wrap_helicsFederateRegisterTypePublication (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  arg4 = reinterpret_cast<char *> (buf4);
  result = (helics_publication)helicsFederateRegisterTypePublication (arg1, (char const *)arg2, (char const *)arg3,
                                                                      (char const *)arg4, arg5);
  _out = SWIG_NewPointerObj (SWIG_as_voidptr (result), SWIGTYPE_p_void, 0 | 0);
  if (_out)
    --resc, *resv++ = _out;
...
int _wrap_helicsFederateRegisterGlobalTypePublication (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  arg4 = reinterpret_cast<char *> (buf4);
  result =
    (helics_publication)helicsFederateRegisterGlobalTypePublication (arg1, (char const *)arg2, (char const *)arg3,
                                                                     (char const *)arg4, arg5);
  _out = SWIG_NewPointerObj (SWIG_as_voidptr (result), SWIGTYPE_p_void, 0 | 0);
  if (_out)
    --resc, *resv++ = _out;
...
int _wrap_helicsFederateRegisterGlobalTypeInput (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  arg4 = reinterpret_cast<char *> (buf4);
  result = (helics_publication)helicsFederateRegisterGlobalTypeInput (arg1, (char const *)arg2, (char const *)arg3,
                                                                      (char const *)arg4, arg5);
  _out = SWIG_NewPointerObj (SWIG_as_voidptr (result), SWIGTYPE_p_void, 0 | 0);
  if (_out)
    --resc, *resv++ = _out;
...
int _wrap_helicsInputGetRawValue (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    if (--resc >= 0)
      *resv++ = SWIG_FromCharPtrAndSize (arg2, *arg4);
  }
  {
    if (arg2)
      free (arg2);
...
int _wrap_helicsInputGetString (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    if (--resc >= 0)
      *resv++ = SWIG_FromCharPtrAndSize (arg2, *arg4 - 1);
  }
  {
    if (arg2)
      free (arg2);
...
int _wrap_helicsInputGetNamedPoint (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    if (--resc >= 0)
      *resv++ = SWIG_From_double ((*arg5));
  }
  else
  {
    int new_flags = SWIG_IsNewObj (res5) ? (SWIG_POINTER_OWN | 0) : 0;
    if (--resc >= 0)
      *resv++ = SWIG_NewPointerObj ((void *)(arg5), SWIGTYPE_p_double, new_flags);
  }
  {
    if (arg2)
      free (arg2);
...
int _wrap_helicsEndpointGetMessage (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  _out = SWIG_NewPointerObj ((new helics_message (static_cast<const helics_message &> (result))),
...
static swig_type_info _swigt__p_helics_iteration_request = {
  "_p_helics_iteration_request", "enum helics_iteration_request *|helics_iteration_request *", 0, 0, (void *)0, 0};
...
static swig_type_info _swigt__p_helics_message = {
  "_p_helics_message", "helics_message *", 0, 0, (void *)"helics.helics_message", 0};
...
SWIGINTERN const char *SwigConstantName (int con_id)
{
  ...
  {
  case 0:
    return "helics_core_type_default";
  case 1:
    return "helics_core_type_zmq";
  case 2:
    return "helics_core_type_mpi";
  case 3:
    return "helics_core_type_test";
  case 4:
    return "helics_core_type_interprocess";
  case 5:
    return "helics_core_type_ipc";
  case 6:
    return "helics_core_type_tcp";
  case 7:
    return "helics_core_type_udp";
  case 8:
    return "helics_core_type_zmq_test";
  case 9:
    return "helics_core_type_nng";
  case 10:
    return "helics_core_type_tcp_ss";
  case 11:
    return "helics_core_type_http";
  case 12:
    return "helics_core_type_websocket";
  case 13:
    return "helics_core_type_inproc";
  case 14:
    return "helics_data_type_string";
  case 15:
    return "helics_data_type_double";
  case 16:
    return "helics_data_type_int";
  case 17:
    return "helics_data_type_complex";
  case 18:
    return "helics_data_type_vector";
  case 19:
    return "helics_data_type_complex_vector";
  case 20:
    return "helics_data_type_named_point";
  case 21:
    return "helics_data_type_boolean";
  case 22:
    return "helics_data_type_time";
  case 23:
    return "helics_data_type_raw";
  case 24:
    return "helics_data_type_any";
  case 25:
    return "helics_flag_observer";
  case 26:
    return "helics_flag_uninterruptible";
  case 27:
    return "helics_flag_interruptible";
  case 28:
    return "helics_flag_source_only";
  case 29:
    return "helics_flag_only_transmit_on_change";
  case 30:
    return "helics_flag_only_update_on_change";
  case 31:
    return "helics_flag_wait_for_current_time_update";
  case 32:
    return "helics_flag_restrictive_time_policy";
  case 33:
    return "helics_flag_rollback";
  case 34:
    return "helics_flag_forward_compute";
  case 35:
    return "helics_flag_realtime";
  case 36:
    return "helics_flag_single_thread_federate";
  case 37:
    return "helics_flag_delay_init_entry";
  case 38:
    return "helics_flag_enable_init_entry";
  case 39:
    return "helics_flag_ignore_time_mismatch_warnings";
  case 40:
    return "helics_log_level_no_print";
  case 41:
    return "helics_log_level_error";
  case 42:
    return "helics_log_level_warning";
  case 43:
    return "helics_log_level_summary";
  case 44:
    return "helics_log_level_connections";
  case 45:
    return "helics_log_level_interfaces";
  case 46:
    return "helics_log_level_timing";
  case 47:
    return "helics_log_level_data";
  case 48:
    return "helics_log_level_trace";
  case 49:
    return "helics_ok";
  case 50:
    return "helics_error_registration_failure";
  case 51:
    return "helics_error_connection_failure";
  case 52:
    return "helics_error_invalid_object";
  case 53:
    return "helics_error_invalid_argument";
  case 54:
    return "helics_error_discard";
  case 55:
    return "helics_error_system_failure";
  case 56:
    return "helics_warning";
  case 57:
    return "helics_error_invalid_state_transition";
  case 58:
    return "helics_error_invalid_function_call";
  case 59:
    return "helics_error_execution_failure";
  case 60:
    return "helics_error_insufficient_space";
  case 61:
    return "helics_error_other";
  case 62:
    return "helics_error_external_type";
  case 63:
    return "helics_property_time_delta";
  case 64:
    return "helics_property_time_period";
  case 65:
    return "helics_property_time_offset";
  case 66:
    return "helics_property_time_rt_lag";
  case 67:
    return "helics_property_time_rt_lead";
  case 68:
    return "helics_property_time_rt_tolerance";
  case 69:
    return "helics_property_time_input_delay";
  case 70:
    return "helics_property_time_output_delay";
  case 71:
    return "helics_property_int_max_iterations";
  case 72:
    return "helics_property_int_log_level";
  case 73:
    return "helics_property_int_file_log_level";
  case 74:
    return "helics_property_int_console_log_level";
  case 75:
    return "helics_handle_option_connection_required";
  case 76:
    return "helics_handle_option_connection_optional";
  case 77:
    return "helics_handle_option_single_connection_only";
  case 78:
    return "helics_handle_option_multiple_connections_allowed";
  case 79:
    return "helics_handle_option_buffer_data";
  case 80:
    return "helics_handle_option_strict_type_checking";
  case 81:
    return "helics_handle_option_ignore_unit_mismatch";
  case 82:
    return "helics_handle_option_only_transmit_on_change";
  case 83:
    return "helics_handle_option_only_update_on_change";
  case 84:
    return "helics_handle_option_ignore_interrupts";
  case 85:
    return "helics_filter_type_custom";
  case 86:
    return "helics_filter_type_delay";
  case 87:
    return "helics_filter_type_random_delay";
  case 88:
    return "helics_filter_type_random_drop";
  case 89:
    return "helics_filter_type_reroute";
  case 90:
    return "helics_filter_type_clone";
  case 91:
    return "helics_filter_type_firewall";
  case 92:
    return "helics_iteration_request_no_iteration";
  case 93:
    return "helics_iteration_request_force_iteration";
  case 94:
    return "helics_iteration_request_iterate_if_needed";
  case 95:
  ...
  case 99:
    return "helics_state_startup";
  case 100:
    return "helics_state_initialization";
  case 101:
    return "helics_state_execution";
  case 102:
    return "helics_state_finalize";
  case 103:
    return "helics_state_error";
  case 104:
    return "helics_state_pending_init";
  case 105:
    return "helics_state_pending_exec";
  case 106:
    return "helics_state_pending_time";
  case 107:
    return "helics_state_pending_iterative_time";
  case 108:
    return "helics_state_pending_finalize";
  default:
    return 0;
  }
}
...
SWIGINTERN int swigConstantName (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    SWIG_Error (SWIG_RuntimeError, "This mex file should only be called from inside the .m files generated by "
                                   "SWIG. The input should be the constant ID.");
    return 1;
  }
  if (resc != 1)
  {
...
SWIGINTERN int swigConstant (int SWIGUNUSEDPARM (resc), mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    SWIG_Error (SWIG_RuntimeError, "This function should only be called from inside the .m files generated by "
                                   "SWIG. First input should be the constant ID .");
    return 1;
  }
  int con_id = (int)mxGetScalar (*argv++);
  switch (con_id)
  {
  case 0:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_default",
                                     SWIG_From_int (static_cast<int> (helics_core_type_default)));
    ;
    break;
  case 1:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_zmq",
                                     SWIG_From_int (static_cast<int> (helics_core_type_zmq)));
    ;
    break;
  case 2:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_mpi",
                                     SWIG_From_int (static_cast<int> (helics_core_type_mpi)));
    ;
    break;
  case 3:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_test",
                                     SWIG_From_int (static_cast<int> (helics_core_type_test)));
    ;
    break;
  case 4:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_interprocess",
                                     SWIG_From_int (static_cast<int> (helics_core_type_interprocess)));
    ;
    break;
  case 5:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_ipc",
                                     SWIG_From_int (static_cast<int> (helics_core_type_ipc)));
    ;
    break;
  case 6:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_tcp",
                                     SWIG_From_int (static_cast<int> (helics_core_type_tcp)));
    ;
    break;
  case 7:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_udp",
                                     SWIG_From_int (static_cast<int> (helics_core_type_udp)));
    ;
    break;
  case 8:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_zmq_test",
                                     SWIG_From_int (static_cast<int> (helics_core_type_zmq_test)));
    ;
    break;
  case 9:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_nng",
                                     SWIG_From_int (static_cast<int> (helics_core_type_nng)));
    ;
    break;
  case 10:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_tcp_ss",
                                     SWIG_From_int (static_cast<int> (helics_core_type_tcp_ss)));
    ;
    break;
  case 11:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_http",
                                     SWIG_From_int (static_cast<int> (helics_core_type_http)));
    ;
    break;
  case 12:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_websocket",
                                     SWIG_From_int (static_cast<int> (helics_core_type_websocket)));
    ;
    break;
  case 13:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_core_type_inproc",
                                     SWIG_From_int (static_cast<int> (helics_core_type_inproc)));
    ;
    break;
  case 14:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_string",
                                     SWIG_From_int (static_cast<int> (helics_data_type_string)));
    ;
    break;
  case 15:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_double",
                                     SWIG_From_int (static_cast<int> (helics_data_type_double)));
    ;
    break;
  case 16:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_int",
                                     SWIG_From_int (static_cast<int> (helics_data_type_int)));
    ;
    break;
  case 17:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_complex",
                                     SWIG_From_int (static_cast<int> (helics_data_type_complex)));
    ;
    break;
  case 18:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_vector",
                                     SWIG_From_int (static_cast<int> (helics_data_type_vector)));
    ;
    break;
  case 19:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_complex_vector",
                                     SWIG_From_int (static_cast<int> (helics_data_type_complex_vector)));
    ;
    break;
  case 20:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_named_point",
                                     SWIG_From_int (static_cast<int> (helics_data_type_named_point)));
    ;
    break;
  case 21:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_boolean",
                                     SWIG_From_int (static_cast<int> (helics_data_type_boolean)));
    ;
    break;
  case 22:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_time",
                                     SWIG_From_int (static_cast<int> (helics_data_type_time)));
    ;
    break;
  case 23:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_raw",
                                     SWIG_From_int (static_cast<int> (helics_data_type_raw)));
    ;
    break;
  case 24:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_data_type_any",
                                     SWIG_From_int (static_cast<int> (helics_data_type_any)));
    ;
    break;
  case 25:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_observer",
                                     SWIG_From_int (static_cast<int> (helics_flag_observer)));
    ;
    break;
  case 26:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_uninterruptible",
                                     SWIG_From_int (static_cast<int> (helics_flag_uninterruptible)));
    ;
    break;
  case 27:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_interruptible",
                                     SWIG_From_int (static_cast<int> (helics_flag_interruptible)));
    ;
    break;
  case 28:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_source_only",
                                     SWIG_From_int (static_cast<int> (helics_flag_source_only)));
    ;
    break;
  case 29:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_only_transmit_on_change",
                                     SWIG_From_int (static_cast<int> (helics_flag_only_transmit_on_change)));
    ;
    break;
  case 30:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_only_update_on_change",
                                     SWIG_From_int (static_cast<int> (helics_flag_only_update_on_change)));
    ;
    break;
  case 31:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_wait_for_current_time_update",
                                     SWIG_From_int (static_cast<int> (helics_flag_wait_for_current_time_update)));
    ;
    break;
  case 32:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_restrictive_time_policy",
                                     SWIG_From_int (static_cast<int> (helics_flag_restrictive_time_policy)));
    ;
    break;
  case 33:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_rollback",
                                     SWIG_From_int (static_cast<int> (helics_flag_rollback)));
    ;
    break;
  case 34:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_forward_compute",
                                     SWIG_From_int (static_cast<int> (helics_flag_forward_compute)));
    ;
    break;
  case 35:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_realtime",
                                     SWIG_From_int (static_cast<int> (helics_flag_realtime)));
    ;
    break;
  case 36:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_single_thread_federate",
                                     SWIG_From_int (static_cast<int> (helics_flag_single_thread_federate)));
    ;
    break;
  case 37:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_delay_init_entry",
                                     SWIG_From_int (static_cast<int> (helics_flag_delay_init_entry)));
    ;
    break;
  case 38:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_enable_init_entry",
                                     SWIG_From_int (static_cast<int> (helics_flag_enable_init_entry)));
    ;
    break;
  case 39:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_flag_ignore_time_mismatch_warnings",
                                     SWIG_From_int (static_cast<int> (helics_flag_ignore_time_mismatch_warnings)));
    ;
    break;
  case 40:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_no_print",
                                     SWIG_From_int (static_cast<int> (helics_log_level_no_print)));
    ;
    break;
  case 41:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_error",
                                     SWIG_From_int (static_cast<int> (helics_log_level_error)));
    ;
    break;
  case 42:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_warning",
                                     SWIG_From_int (static_cast<int> (helics_log_level_warning)));
    ;
    break;
  case 43:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_summary",
                                     SWIG_From_int (static_cast<int> (helics_log_level_summary)));
    ;
    break;
  case 44:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_connections",
                                     SWIG_From_int (static_cast<int> (helics_log_level_connections)));
    ;
    break;
  case 45:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_interfaces",
                                     SWIG_From_int (static_cast<int> (helics_log_level_interfaces)));
    ;
    break;
  case 46:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_timing",
                                     SWIG_From_int (static_cast<int> (helics_log_level_timing)));
    ;
    break;
  case 47:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_data",
                                     SWIG_From_int (static_cast<int> (helics_log_level_data)));
    ;
    break;
  case 48:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_log_level_trace",
                                     SWIG_From_int (static_cast<int> (helics_log_level_trace)));
    ;
    break;
  case 49:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_ok", SWIG_From_int (static_cast<int> (helics_ok)));
    ;
    break;
  case 50:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_registration_failure",
                                     SWIG_From_int (static_cast<int> (helics_error_registration_failure)));
    ;
    break;
  case 51:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_connection_failure",
                                     SWIG_From_int (static_cast<int> (helics_error_connection_failure)));
    ;
    break;
  case 52:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_invalid_object",
                                     SWIG_From_int (static_cast<int> (helics_error_invalid_object)));
    ;
    break;
  case 53:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_invalid_argument",
                                     SWIG_From_int (static_cast<int> (helics_error_invalid_argument)));
    ;
    break;
  case 54:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_discard",
                                     SWIG_From_int (static_cast<int> (helics_error_discard)));
    ;
    break;
  case 55:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_system_failure",
                                     SWIG_From_int (static_cast<int> (helics_error_system_failure)));
    ;
    break;
  case 56:
    *resv =
      SWIG_Matlab_SetConstant (module_ns, "helics_warning", SWIG_From_int (static_cast<int> (helics_warning)));
    ;
    break;
  case 57:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_invalid_state_transition",
                                     SWIG_From_int (static_cast<int> (helics_error_invalid_state_transition)));
    ;
    break;
  case 58:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_invalid_function_call",
                                     SWIG_From_int (static_cast<int> (helics_error_invalid_function_call)));
    ;
    break;
  case 59:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_execution_failure",
                                     SWIG_From_int (static_cast<int> (helics_error_execution_failure)));
    ;
    break;
  case 60:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_insufficient_space",
                                     SWIG_From_int (static_cast<int> (helics_error_insufficient_space)));
    ;
    break;
  case 61:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_other",
                                     SWIG_From_int (static_cast<int> (helics_error_other)));
    ;
    break;
  case 62:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_error_external_type",
                                     SWIG_From_int (static_cast<int> (helics_error_external_type)));
    ;
    break;
  case 63:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_delta",
                                     SWIG_From_int (static_cast<int> (helics_property_time_delta)));
    ;
    break;
  case 64:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_period",
                                     SWIG_From_int (static_cast<int> (helics_property_time_period)));
    ;
    break;
  case 65:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_offset",
                                     SWIG_From_int (static_cast<int> (helics_property_time_offset)));
    ;
    break;
  case 66:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_rt_lag",
                                     SWIG_From_int (static_cast<int> (helics_property_time_rt_lag)));
    ;
    break;
  case 67:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_rt_lead",
                                     SWIG_From_int (static_cast<int> (helics_property_time_rt_lead)));
    ;
    break;
  case 68:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_rt_tolerance",
                                     SWIG_From_int (static_cast<int> (helics_property_time_rt_tolerance)));
    ;
    break;
  case 69:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_input_delay",
                                     SWIG_From_int (static_cast<int> (helics_property_time_input_delay)));
    ;
    break;
  case 70:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_time_output_delay",
                                     SWIG_From_int (static_cast<int> (helics_property_time_output_delay)));
    ;
    break;
  case 71:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_int_max_iterations",
                                     SWIG_From_int (static_cast<int> (helics_property_int_max_iterations)));
    ;
    break;
  case 72:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_int_log_level",
                                     SWIG_From_int (static_cast<int> (helics_property_int_log_level)));
    ;
    break;
  case 73:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_int_file_log_level",
                                     SWIG_From_int (static_cast<int> (helics_property_int_file_log_level)));
    ;
    break;
  case 74:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_property_int_console_log_level",
                                     SWIG_From_int (static_cast<int> (helics_property_int_console_log_level)));
    ;
    break;
  case 75:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_connection_required",
                                     SWIG_From_int (static_cast<int> (helics_handle_option_connection_required)));
    ;
    break;
  case 76:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_connection_optional",
                                     SWIG_From_int (static_cast<int> (helics_handle_option_connection_optional)));
    ;
    break;
  case 77:
    *resv =
      SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_single_connection_only",
                               SWIG_From_int (static_cast<int> (helics_handle_option_single_connection_only)));
    ;
    break;
  case 78:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_multiple_connections_allowed",
                                     SWIG_From_int (
                                       static_cast<int> (helics_handle_option_multiple_connections_allowed)));
    ;
    break;
  case 79:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_buffer_data",
                                     SWIG_From_int (static_cast<int> (helics_handle_option_buffer_data)));
    ;
    break;
  case 80:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_strict_type_checking",
                                     SWIG_From_int (static_cast<int> (helics_handle_option_strict_type_checking)));
    ;
    break;
  case 81:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_ignore_unit_mismatch",
                                     SWIG_From_int (static_cast<int> (helics_handle_option_ignore_unit_mismatch)));
    ;
    break;
  case 82:
    *resv =
      SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_only_transmit_on_change",
                               SWIG_From_int (static_cast<int> (helics_handle_option_only_transmit_on_change)));
    ;
    break;
  case 83:
    *resv =
      SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_only_update_on_change",
                               SWIG_From_int (static_cast<int> (helics_handle_option_only_update_on_change)));
    ;
    break;
  case 84:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_ignore_interrupts",
                                     SWIG_From_int (static_cast<int> (helics_handle_option_ignore_interrupts)));
    ;
    break;
  case 85:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_custom",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_custom)));
    ;
    break;
  case 86:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_delay",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_delay)));
    ;
    break;
  case 87:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_random_delay",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_random_delay)));
    ;
    break;
  case 88:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_random_drop",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_random_drop)));
    ;
    break;
  case 89:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_reroute",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_reroute)));
    ;
    break;
  case 90:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_clone",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_clone)));
    ;
    break;
  case 91:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_filter_type_firewall",
                                     SWIG_From_int (static_cast<int> (helics_filter_type_firewall)));
    ;
    break;
  case 92:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_iteration_request_no_iteration",
                                     SWIG_From_int (static_cast<int> (helics_iteration_request_no_iteration)));
    ;
    break;
  case 93:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_iteration_request_force_iteration",
                                     SWIG_From_int (static_cast<int> (helics_iteration_request_force_iteration)));
    ;
    break;
  case 94:
    *resv =
      SWIG_Matlab_SetConstant (module_ns, "helics_iteration_request_iterate_if_needed",
                               SWIG_From_int (static_cast<int> (helics_iteration_request_iterate_if_needed)));
    ;
    break;
  case 95:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_iteration_result_next_step",
                                     SWIG_From_int (static_cast<int> (helics_iteration_result_next_step)));
    ;
    break;
  case 96:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_iteration_result_error",
                                     SWIG_From_int (static_cast<int> (helics_iteration_result_error)));
    ;
    break;
  case 97:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_iteration_result_halted",
                                     SWIG_From_int (static_cast<int> (helics_iteration_result_halted)));
    ;
    break;
  case 98:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_iteration_result_iterating",
                                     SWIG_From_int (static_cast<int> (helics_iteration_result_iterating)));
    ;
    break;
  case 99:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_startup",
                                     SWIG_From_int (static_cast<int> (helics_state_startup)));
    ;
    break;
  case 100:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_initialization",
                                     SWIG_From_int (static_cast<int> (helics_state_initialization)));
    ;
    break;
  case 101:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_execution",
                                     SWIG_From_int (static_cast<int> (helics_state_execution)));
    ;
    break;
  case 102:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_finalize",
                                     SWIG_From_int (static_cast<int> (helics_state_finalize)));
    ;
    break;
  case 103:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_error",
                                     SWIG_From_int (static_cast<int> (helics_state_error)));
    ;
    break;
  case 104:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_pending_init",
                                     SWIG_From_int (static_cast<int> (helics_state_pending_init)));
    ;
    break;
  case 105:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_pending_exec",
                                     SWIG_From_int (static_cast<int> (helics_state_pending_exec)));
    ;
    break;
  case 106:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_pending_time",
                                     SWIG_From_int (static_cast<int> (helics_state_pending_time)));
    ;
    break;
  case 107:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_pending_iterative_time",
                                     SWIG_From_int (static_cast<int> (helics_state_pending_iterative_time)));
    ;
    break;
  case 108:
    *resv = SWIG_Matlab_SetConstant (module_ns, "helics_state_pending_finalize",
                                     SWIG_From_int (static_cast<int> (helics_state_pending_finalize)));
    ;
    break;
  default:
...
SWIGINTERN const char *SwigFunctionName (int fcn_id)
{
  ...
  case 4:
    return "swigTouch";
  case 5:
    return "helics_time_zero_get";
  case 6:
    return "helics_time_epsilon_get";
  case 7:
    return "helics_time_invalid_get";
  case 8:
    return "helics_time_maxtime_get";
  case 9:
    return "helics_true_get";
  case 10:
    return "helics_false_get";
  case 11:
    return "helics_message_time_get";
  case 12:
    return "helics_message_time_set";
  case 13:
    return "helics_message_data_get";
  case 14:
    return "helics_message_data_set";
  case 15:
    return "helics_message_length_get";
  case 16:
    return "helics_message_length_set";
  case 17:
    return "helics_message_messageID_get";
  case 18:
    return "helics_message_messageID_set";
  case 19:
    return "helics_message_flags_get";
  case 20:
    return "helics_message_flags_set";
  case 21:
    return "helics_message_original_source_get";
  case 22:
    return "helics_message_original_source_set";
  case 23:
    return "helics_message_source_get";
  case 24:
    return "helics_message_source_set";
  case 25:
    return "helics_message_dest_get";
  case 26:
    return "helics_message_dest_set";
  case 27:
    return "helics_message_original_dest_get";
  case 28:
    return "helics_message_original_dest_set";
  case 29:
    return "new_helics_message";
  case 30:
    return "delete_helics_message";
  case 31:
    return "_wrap_helicsGetVersion";
  case 32:
    return "_wrap_helicsIsCoreTypeAvailable";
  case 33:
    return "_wrap_helicsCreateCore";
  case 34:
    return "_wrap_helicsCreateCoreFromArgs";
  case 35:
    return "_wrap_helicsCoreClone";
  case 36:
    return "_wrap_helicsCoreIsValid";
  case 37:
    return "_wrap_helicsCreateBroker";
  case 38:
    return "_wrap_helicsCreateBrokerFromArgs";
  case 39:
    return "_wrap_helicsBrokerClone";
  case 40:
    return "_wrap_helicsBrokerIsValid";
  case 41:
    return "_wrap_helicsBrokerIsConnected";
  case 42:
    return "_wrap_helicsBrokerDataLink";
  case 43:
    return "_wrap_helicsBrokerAddSourceFilterToEndpoint";
  case 44:
    return "_wrap_helicsBrokerAddDestinationFilterToEndpoint";
  case 45:
    return "_wrap_helicsBrokerMakeConnections";
  case 46:
    return "_wrap_helicsCoreWaitForDisconnect";
  case 47:
    return "_wrap_helicsBrokerWaitForDisconnect";
  case 48:
    return "_wrap_helicsCoreIsConnected";
  case 49:
    return "_wrap_helicsCoreDataLink";
  case 50:
    return "_wrap_helicsCoreAddSourceFilterToEndpoint";
  case 51:
    return "_wrap_helicsCoreAddDestinationFilterToEndpoint";
  case 52:
    return "_wrap_helicsCoreMakeConnections";
  case 53:
    return "_wrap_helicsBrokerGetIdentifier";
  case 54:
    return "_wrap_helicsCoreGetIdentifier";
  case 55:
    return "_wrap_helicsBrokerGetAddress";
  case 56:
    return "_wrap_helicsCoreGetAddress";
  case 57:
    return "_wrap_helicsCoreSetReadyToInit";
  case 58:
    return "_wrap_helicsCoreDisconnect";
  case 59:
    return "_wrap_helicsGetFederateByName";
  case 60:
    return "_wrap_helicsBrokerDisconnect";
  case 61:
    return "_wrap_helicsFederateDestroy";
  case 62:
    return "_wrap_helicsBrokerDestroy";
  case 63:
    return "_wrap_helicsCoreDestroy";
  case 64:
    return "_wrap_helicsCoreFree";
  case 65:
    return "_wrap_helicsBrokerFree";
  case 66:
    return "_wrap_helicsCreateValueFederate";
  case 67:
    return "_wrap_helicsCreateValueFederateFromConfig";
  case 68:
    return "_wrap_helicsCreateMessageFederate";
  case 69:
    return "_wrap_helicsCreateMessageFederateFromConfig";
  case 70:
    return "_wrap_helicsCreateCombinationFederate";
  case 71:
    return "_wrap_helicsCreateCombinationFederateFromConfig";
  case 72:
    return "_wrap_helicsFederateClone";
  case 73:
    return "_wrap_helicsCreateFederateInfo";
  case 74:
    return "_wrap_helicsFederateInfoClone";
  case 75:
    return "_wrap_helicsFederateInfoLoadFromArgs";
  case 76:
    return "_wrap_helicsFederateInfoFree";
  case 77:
    return "_wrap_helicsFederateIsValid";
  case 78:
    return "_wrap_helicsFederateInfoSetCoreName";
  case 79:
    return "_wrap_helicsFederateInfoSetCoreInitString";
  case 80:
    return "_wrap_helicsFederateInfoSetBrokerInitString";
  case 81:
    return "_wrap_helicsFederateInfoSetCoreType";
  case 82:
    return "_wrap_helicsFederateInfoSetCoreTypeFromString";
  case 83:
    return "_wrap_helicsFederateInfoSetBroker";
  case 84:
    return "_wrap_helicsFederateInfoSetBrokerKey";
  case 85:
    return "_wrap_helicsFederateInfoSetBrokerPort";
  case 86:
    return "_wrap_helicsFederateInfoSetLocalPort";
  case 87:
    return "_wrap_helicsGetPropertyIndex";
  case 88:
    return "_wrap_helicsGetOptionIndex";
  case 89:
    return "_wrap_helicsFederateInfoSetFlagOption";
  case 90:
    return "_wrap_helicsFederateInfoSetSeparator";
  case 91:
    return "_wrap_helicsFederateInfoSetTimeProperty";
  case 92:
    return "_wrap_helicsFederateInfoSetIntegerProperty";
  case 93:
    return "_wrap_helicsFederateRegisterInterfaces";
  case 94:
    return "_wrap_helicsFederateFinalize";
  case 95:
    return "_wrap_helicsFederateFinalizeAsync";
  case 96:
    return "_wrap_helicsFederateFinalizeComplete";
  case 97:
    return "_wrap_helicsFederateFree";
  case 98:
    return "_wrap_helicsCloseLibrary";
  case 99:
    return "_wrap_helicsFederateEnterInitializingMode";
  case 100:
    return "_wrap_helicsFederateEnterInitializingModeAsync";
  case 101:
    return "_wrap_helicsFederateIsAsyncOperationCompleted";
  case 102:
    return "_wrap_helicsFederateEnterInitializingModeComplete";
  case 103:
    return "_wrap_helicsFederateEnterExecutingMode";
  case 104:
    return "_wrap_helicsFederateEnterExecutingModeAsync";
  case 105:
    return "_wrap_helicsFederateEnterExecutingModeComplete";
  case 106:
    return "_wrap_helicsFederateEnterExecutingModeIterative";
  case 107:
    return "_wrap_helicsFederateEnterExecutingModeIterativeAsync";
  case 108:
    return "_wrap_helicsFederateEnterExecutingModeIterativeComplete";
  case 109:
    return "_wrap_helicsFederateGetState";
  case 110:
    return "_wrap_helicsFederateGetCoreObject";
  case 111:
    return "_wrap_helicsFederateRequestTime";
  case 112:
    return "_wrap_helicsFederateRequestTimeAdvance";
  case 113:
    return "_wrap_helicsFederateRequestNextStep";
  case 114:
    return "_wrap_helicsFederateRequestTimeIterative";
  case 115:
    return "_wrap_helicsFederateRequestTimeAsync";
  case 116:
    return "_wrap_helicsFederateRequestTimeComplete";
  case 117:
    return "_wrap_helicsFederateRequestTimeIterativeAsync";
  case 118:
    return "_wrap_helicsFederateRequestTimeIterativeComplete";
  case 119:
    return "_wrap_helicsFederateGetName";
  case 120:
    return "_wrap_helicsFederateSetTimeProperty";
  case 121:
    return "_wrap_helicsFederateSetFlagOption";
  case 122:
    return "_wrap_helicsFederateSetSeparator";
  case 123:
    return "_wrap_helicsFederateSetIntegerProperty";
  case 124:
    return "_wrap_helicsFederateGetTimeProperty";
  case 125:
    return "_wrap_helicsFederateGetFlagOption";
  case 126:
    return "_wrap_helicsFederateGetIntegerProperty";
  case 127:
    return "_wrap_helicsFederateGetCurrentTime";
  case 128:
    return "_wrap_helicsFederateSetGlobal";
  case 129:
    return "_wrap_helicsFederateSetLogFile";
  case 130:
    return "_wrap_helicsFederateLogErrorMessage";
  case 131:
    return "_wrap_helicsFederateLogWarningMessage";
  case 132:
    return "_wrap_helicsFederateLogInfoMessage";
  case 133:
    return "_wrap_helicsFederateLogDebugMessage";
  case 134:
    return "_wrap_helicsFederateLogLevelMessage";
  case 135:
    return "_wrap_helicsCoreSetGlobal";
  case 136:
    return "_wrap_helicsBrokerSetGlobal";
  case 137:
    return "_wrap_helicsCoreSetLogFile";
  case 138:
    return "_wrap_helicsBrokerSetLogFile";
  case 139:
    return "_wrap_helicsCreateQuery";
  case 140:
    return "_wrap_helicsQueryExecute";
  case 141:
    return "_wrap_helicsQueryCoreExecute";
  case 142:
    return "_wrap_helicsQueryBrokerExecute";
  case 143:
    return "_wrap_helicsQueryExecuteAsync";
  case 144:
    return "_wrap_helicsQueryExecuteComplete";
  case 145:
    return "_wrap_helicsQueryIsCompleted";
  case 146:
    return "_wrap_helicsQueryFree";
  case 147:
    return "_wrap_helicsCleanupLibrary";
  case 148:
    return "_wrap_helicsFederateRegisterSubscription";
  case 149:
    return "_wrap_helicsFederateRegisterPublication";
  case 150:
    return "_wrap_helicsFederateRegisterTypePublication";
  case 151:
  ...
  case 154:
    return "_wrap_helicsFederateRegisterTypeInput";
  case 155:
    return "_wrap_helicsFederateRegisterGlobalInput";
  case 156:
    return "_wrap_helicsFederateRegisterGlobalTypeInput";
  case 157:
    return "_wrap_helicsFederateGetPublication";
  case 158:
    return "_wrap_helicsFederateGetPublicationByIndex";
  case 159:
    return "_wrap_helicsFederateGetInput";
  case 160:
    return "_wrap_helicsFederateGetInputByIndex";
  case 161:
    return "_wrap_helicsFederateGetSubscription";
  case 162:
    return "_wrap_helicsFederateClearUpdates";
  case 163:
    return "_wrap_helicsFederateRegisterFromPublicationJSON";
  case 164:
    return "_wrap_helicsFederatePublishJSON";
  case 165:
    return "_wrap_helicsPublicationPublishRaw";
  case 166:
    return "_wrap_helicsPublicationPublishString";
  case 167:
    return "_wrap_helicsPublicationPublishInteger";
  case 168:
    return "_wrap_helicsPublicationPublishBoolean";
  case 169:
    return "_wrap_helicsPublicationPublishDouble";
  case 170:
    return "_wrap_helicsPublicationPublishTime";
  case 171:
    return "_wrap_helicsPublicationPublishChar";
  case 172:
    return "_wrap_helicsPublicationPublishComplex";
  case 173:
    return "_wrap_helicsPublicationPublishVector";
  case 174:
    return "_wrap_helicsPublicationPublishNamedPoint";
  case 175:
    return "_wrap_helicsPublicationAddTarget";
  case 176:
    return "_wrap_helicsInputAddTarget";
  case 177:
    return "_wrap_helicsInputGetRawValueSize";
  case 178:
    return "_wrap_helicsInputGetRawValue";
  case 179:
    return "_wrap_helicsInputGetStringSize";
  case 180:
    return "_wrap_helicsInputGetString";
  case 181:
    return "_wrap_helicsInputGetInteger";
  case 182:
    return "_wrap_helicsInputGetBoolean";
  case 183:
    return "_wrap_helicsInputGetDouble";
  case 184:
    return "_wrap_helicsInputGetTime";
  case 185:
    return "_wrap_helicsInputGetChar";
  case 186:
    return "_wrap_helicsInputGetComplex";
  case 187:
    return "_wrap_helicsInputGetVectorSize";
  case 188:
    return "_wrap_helicsInputGetVector";
  case 189:
    return "_wrap_helicsInputGetNamedPoint";
  case 190:
    return "_wrap_helicsInputSetDefaultRaw";
  case 191:
    return "_wrap_helicsInputSetDefaultString";
  case 192:
    return "_wrap_helicsInputSetDefaultInteger";
  case 193:
    return "_wrap_helicsInputSetDefaultBoolean";
  case 194:
    return "_wrap_helicsInputSetDefaultTime";
  case 195:
    return "_wrap_helicsInputSetDefaultChar";
  case 196:
    return "_wrap_helicsInputSetDefaultDouble";
  case 197:
    return "_wrap_helicsInputSetDefaultComplex";
  case 198:
    return "_wrap_helicsInputSetDefaultVector";
  case 199:
    return "_wrap_helicsInputSetDefaultNamedPoint";
  case 200:
    return "_wrap_helicsInputGetType";
  case 201:
    return "_wrap_helicsInputGetPublicationType";
  case 202:
    return "_wrap_helicsPublicationGetType";
  case 203:
    return "_wrap_helicsInputGetKey";
  case 204:
    return "_wrap_helicsSubscriptionGetKey";
  case 205:
    return "_wrap_helicsPublicationGetKey";
  case 206:
    return "_wrap_helicsInputGetUnits";
  case 207:
    return "_wrap_helicsInputGetInjectionUnits";
  case 208:
    return "_wrap_helicsInputGetExtractionUnits";
  case 209:
    return "_wrap_helicsPublicationGetUnits";
  case 210:
    return "_wrap_helicsInputGetInfo";
  case 211:
    return "_wrap_helicsInputSetInfo";
  case 212:
    return "_wrap_helicsPublicationGetInfo";
  case 213:
    return "_wrap_helicsPublicationSetInfo";
  case 214:
    return "_wrap_helicsInputGetOption";
  case 215:
    return "_wrap_helicsInputSetOption";
  case 216:
    return "_wrap_helicsPublicationGetOption";
  case 217:
    return "_wrap_helicsPublicationSetOption";
  case 218:
    return "_wrap_helicsInputIsUpdated";
  case 219:
    return "_wrap_helicsInputLastUpdateTime";
  case 220:
    return "_wrap_helicsInputClearUpdate";
  case 221:
    return "_wrap_helicsFederateGetPublicationCount";
  case 222:
    return "_wrap_helicsFederateGetInputCount";
  case 223:
    return "_wrap_helicsFederateRegisterEndpoint";
  case 224:
    return "_wrap_helicsFederateRegisterGlobalEndpoint";
  case 225:
    return "_wrap_helicsFederateGetEndpoint";
  case 226:
    return "_wrap_helicsFederateGetEndpointByIndex";
  case 227:
    return "_wrap_helicsEndpointSetDefaultDestination";
  case 228:
    return "_wrap_helicsEndpointGetDefaultDestination";
  case 229:
    return "_wrap_helicsEndpointSendMessageRaw";
  case 230:
    return "_wrap_helicsEndpointSendEventRaw";
  case 231:
    return "_wrap_helicsEndpointSendMessage";
  case 232:
    return "_wrap_helicsEndpointSendMessageObject";
  case 233:
    return "_wrap_helicsEndpointSubscribe";
  case 234:
    return "_wrap_helicsFederateHasMessage";
  case 235:
    return "_wrap_helicsEndpointHasMessage";
  case 236:
    return "_wrap_helicsFederatePendingMessages";
  case 237:
    return "_wrap_helicsEndpointPendingMessages";
  case 238:
    return "_wrap_helicsEndpointGetMessage";
  case 239:
    return "_wrap_helicsEndpointGetMessageObject";
  case 240:
    return "_wrap_helicsFederateGetMessage";
  case 241:
    return "_wrap_helicsFederateGetMessageObject";
  case 242:
    return "_wrap_helicsFederateCreateMessageObject";
  case 243:
    return "_wrap_helicsFederateClearMessages";
  case 244:
    return "_wrap_helicsEndpointClearMessages";
  case 245:
    return "_wrap_helicsEndpointGetType";
  case 246:
    return "_wrap_helicsEndpointGetName";
  case 247:
    return "_wrap_helicsFederateGetEndpointCount";
  case 248:
    return "_wrap_helicsEndpointGetInfo";
  case 249:
    return "_wrap_helicsEndpointSetInfo";
  case 250:
    return "_wrap_helicsEndpointSetOption";
  case 251:
    return "_wrap_helicsEndpointGetOption";
  case 252:
    return "_wrap_helicsMessageGetSource";
  case 253:
    return "_wrap_helicsMessageGetDestination";
  case 254:
    return "_wrap_helicsMessageGetOriginalSource";
  case 255:
    return "_wrap_helicsMessageGetOriginalDestination";
  case 256:
    return "_wrap_helicsMessageGetTime";
  case 257:
    return "_wrap_helicsMessageGetString";
  case 258:
    return "_wrap_helicsMessageGetMessageID";
  case 259:
    return "_wrap_helicsMessageCheckFlag";
  case 260:
    return "_wrap_helicsMessageGetRawDataSize";
  case 261:
    return "_wrap_helicsMessageGetRawData";
  case 262:
    return "_wrap_helicsMessageIsValid";
  case 263:
    return "_wrap_helicsMessageSetSource";
  case 264:
    return "_wrap_helicsMessageSetDestination";
  case 265:
    return "_wrap_helicsMessageSetOriginalSource";
  case 266:
    return "_wrap_helicsMessageSetOriginalDestination";
  case 267:
    return "_wrap_helicsMessageSetTime";
  case 268:
    return "_wrap_helicsMessageReserve";
  case 269:
    return "_wrap_helicsMessageSetMessageID";
  case 270:
    return "_wrap_helicsMessageClearFlags";
  case 271:
    return "_wrap_helicsMessageSetFlagOption";
  case 272:
    return "_wrap_helicsMessageSetString";
  case 273:
    return "_wrap_helicsMessageSetData";
  case 274:
    return "_wrap_helicsMessageAppendData";
  case 275:
    return "_wrap_helicsFederateRegisterFilter";
  case 276:
    return "_wrap_helicsFederateRegisterGlobalFilter";
  case 277:
    return "_wrap_helicsFederateRegisterCloningFilter";
  case 278:
    return "_wrap_helicsFederateRegisterGlobalCloningFilter";
  case 279:
    return "_wrap_helicsCoreRegisterFilter";
  case 280:
    return "_wrap_helicsCoreRegisterCloningFilter";
  case 281:
    return "_wrap_helicsFederateGetFilterCount";
  case 282:
    return "_wrap_helicsFederateGetFilter";
  case 283:
    return "_wrap_helicsFederateGetFilterByIndex";
  case 284:
    return "_wrap_helicsFilterGetName";
  case 285:
    return "_wrap_helicsFilterSet";
  case 286:
    return "_wrap_helicsFilterSetString";
  case 287:
    return "_wrap_helicsFilterAddDestinationTarget";
  case 288:
    return "_wrap_helicsFilterAddSourceTarget";
  case 289:
    return "_wrap_helicsFilterAddDeliveryEndpoint";
  case 290:
    return "_wrap_helicsFilterRemoveTarget";
  case 291:
    return "_wrap_helicsFilterRemoveDeliveryEndpoint";
  case 292:
    return "_wrap_helicsFilterGetInfo";
  case 293:
    return "_wrap_helicsFilterSetInfo";
  case 294:
    return "_wrap_helicsFilterSetOption";
  case 295:
    return "_wrap_helicsFilterGetOption";
  default:
    return 0;
  }
}
...
SWIGINTERN int swigFunctionName (int resc, mxArray *resv[], int argc, mxArray *argv[])
{
  ...
  {
    SWIG_Error (SWIG_RuntimeError, "This mex file should only be called from inside the .m files generated by "
                                   "SWIG. The input should be the function ID.");
    return 1;
  }
  if (resc != 1)
  {
...
extern "C" void mexFunction (int resc, mxArray *resv[], int argc, const mxArray *argv[])
{
  ...
  if (--argc < 0 || !mxIsDouble (*argv) || mxGetNumberOfElements (*argv) != 1)
    mexErrMsgTxt ("This mex file should only be called from inside the .m files generated by SWIG. First input "
                  "should be the function ID .");
  int fcn_id = (int)mxGetScalar (*argv++);
  int flag = 0;
  switch (fcn_id)
  {
  ...
  case 4:
    ...
    break;
  case 5:
    flag = _wrap_helics_time_zero_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 6:
    flag = _wrap_helics_time_epsilon_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 7:
    flag = _wrap_helics_time_invalid_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 8:
    flag = _wrap_helics_time_maxtime_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 9:
    flag = _wrap_helics_true_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 10:
    flag = _wrap_helics_false_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 11:
    flag = _wrap_helics_message_time_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 12:
    flag = _wrap_helics_message_time_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 13:
    flag = _wrap_helics_message_data_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 14:
    flag = _wrap_helics_message_data_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 15:
    flag = _wrap_helics_message_length_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 16:
    flag = _wrap_helics_message_length_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 17:
    flag = _wrap_helics_message_messageID_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 18:
    flag = _wrap_helics_message_messageID_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 19:
    flag = _wrap_helics_message_flags_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 20:
    flag = _wrap_helics_message_flags_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 21:
    flag = _wrap_helics_message_original_source_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 22:
    flag = _wrap_helics_message_original_source_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 23:
    flag = _wrap_helics_message_source_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 24:
    flag = _wrap_helics_message_source_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 25:
    flag = _wrap_helics_message_dest_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 26:
    flag = _wrap_helics_message_dest_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 27:
    flag = _wrap_helics_message_original_dest_get (resc, resv, argc, (mxArray **)(argv));
    break;
  case 28:
    flag = _wrap_helics_message_original_dest_set (resc, resv, argc, (mxArray **)(argv));
    break;
  case 29:
    flag = _wrap_new_helics_message (resc, resv, argc, (mxArray **)(argv));
    break;
  case 30:
    flag = _wrap_delete_helics_message (resc, resv, argc, (mxArray **)(argv));
    break;
  case 31:
    flag = _wrap_helicsGetVersion (resc, resv, argc, (mxArray **)(argv));
    break;
  case 32:
    flag = _wrap_helicsIsCoreTypeAvailable (resc, resv, argc, (mxArray **)(argv));
    break;
  case 33:
    flag = _wrap_helicsCreateCore (resc, resv, argc, (mxArray **)(argv));
    break;
  case 34:
    flag = _wrap_helicsCreateCoreFromArgs (resc, resv, argc, (mxArray **)(argv));
    break;
  case 35:
    flag = _wrap_helicsCoreClone (resc, resv, argc, (mxArray **)(argv));
    break;
  case 36:
    flag = _wrap_helicsCoreIsValid (resc, resv, argc, (mxArray **)(argv));
    break;
  case 37:
    flag = _wrap_helicsCreateBroker (resc, resv, argc, (mxArray **)(argv));
    break;
  case 38:
    flag = _wrap_helicsCreateBrokerFromArgs (resc, resv, argc, (mxArray **)(argv));
    break;
  case 39:
    flag = _wrap_helicsBrokerClone (resc, resv, argc, (mxArray **)(argv));
    break;
  case 40:
    flag = _wrap_helicsBrokerIsValid (resc, resv, argc, (mxArray **)(argv));
    break;
  case 41:
    flag = _wrap_helicsBrokerIsConnected (resc, resv, argc, (mxArray **)(argv));
    break;
  case 42:
    flag = _wrap_helicsBrokerDataLink (resc, resv, argc, (mxArray **)(argv));
    break;
  case 43:
    flag = _wrap_helicsBrokerAddSourceFilterToEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 44:
    flag = _wrap_helicsBrokerAddDestinationFilterToEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 45:
    flag = _wrap_helicsBrokerMakeConnections (resc, resv, argc, (mxArray **)(argv));
    break;
  case 46:
    flag = _wrap_helicsCoreWaitForDisconnect (resc, resv, argc, (mxArray **)(argv));
    break;
  case 47:
    flag = _wrap_helicsBrokerWaitForDisconnect (resc, resv, argc, (mxArray **)(argv));
    break;
  case 48:
    flag = _wrap_helicsCoreIsConnected (resc, resv, argc, (mxArray **)(argv));
    break;
  case 49:
    flag = _wrap_helicsCoreDataLink (resc, resv, argc, (mxArray **)(argv));
    break;
  case 50:
    flag = _wrap_helicsCoreAddSourceFilterToEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 51:
    flag = _wrap_helicsCoreAddDestinationFilterToEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 52:
    flag = _wrap_helicsCoreMakeConnections (resc, resv, argc, (mxArray **)(argv));
    break;
  case 53:
    flag = _wrap_helicsBrokerGetIdentifier (resc, resv, argc, (mxArray **)(argv));
    break;
  case 54:
    flag = _wrap_helicsCoreGetIdentifier (resc, resv, argc, (mxArray **)(argv));
    break;
  case 55:
    flag = _wrap_helicsBrokerGetAddress (resc, resv, argc, (mxArray **)(argv));
    break;
  case 56:
    flag = _wrap_helicsCoreGetAddress (resc, resv, argc, (mxArray **)(argv));
    break;
  case 57:
    flag = _wrap_helicsCoreSetReadyToInit (resc, resv, argc, (mxArray **)(argv));
    break;
  case 58:
    flag = _wrap_helicsCoreDisconnect (resc, resv, argc, (mxArray **)(argv));
    break;
  case 59:
    flag = _wrap_helicsGetFederateByName (resc, resv, argc, (mxArray **)(argv));
    break;
  case 60:
    flag = _wrap_helicsBrokerDisconnect (resc, resv, argc, (mxArray **)(argv));
    break;
  case 61:
    flag = _wrap_helicsFederateDestroy (resc, resv, argc, (mxArray **)(argv));
    break;
  case 62:
    flag = _wrap_helicsBrokerDestroy (resc, resv, argc, (mxArray **)(argv));
    break;
  case 63:
    flag = _wrap_helicsCoreDestroy (resc, resv, argc, (mxArray **)(argv));
    break;
  case 64:
    flag = _wrap_helicsCoreFree (resc, resv, argc, (mxArray **)(argv));
    break;
  case 65:
    flag = _wrap_helicsBrokerFree (resc, resv, argc, (mxArray **)(argv));
    break;
  case 66:
    flag = _wrap_helicsCreateValueFederate (resc, resv, argc, (mxArray **)(argv));
    break;
  case 67:
    flag = _wrap_helicsCreateValueFederateFromConfig (resc, resv, argc, (mxArray **)(argv));
    break;
  case 68:
    flag = _wrap_helicsCreateMessageFederate (resc, resv, argc, (mxArray **)(argv));
    break;
  case 69:
    flag = _wrap_helicsCreateMessageFederateFromConfig (resc, resv, argc, (mxArray **)(argv));
    break;
  case 70:
    flag = _wrap_helicsCreateCombinationFederate (resc, resv, argc, (mxArray **)(argv));
    break;
  case 71:
    flag = _wrap_helicsCreateCombinationFederateFromConfig (resc, resv, argc, (mxArray **)(argv));
    break;
  case 72:
    flag = _wrap_helicsFederateClone (resc, resv, argc, (mxArray **)(argv));
    break;
  case 73:
    flag = _wrap_helicsCreateFederateInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 74:
    flag = _wrap_helicsFederateInfoClone (resc, resv, argc, (mxArray **)(argv));
    break;
  case 75:
    flag = _wrap_helicsFederateInfoLoadFromArgs (resc, resv, argc, (mxArray **)(argv));
    break;
  case 76:
    flag = _wrap_helicsFederateInfoFree (resc, resv, argc, (mxArray **)(argv));
    break;
  case 77:
    flag = _wrap_helicsFederateIsValid (resc, resv, argc, (mxArray **)(argv));
    break;
  case 78:
    flag = _wrap_helicsFederateInfoSetCoreName (resc, resv, argc, (mxArray **)(argv));
    break;
  case 79:
    flag = _wrap_helicsFederateInfoSetCoreInitString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 80:
    flag = _wrap_helicsFederateInfoSetBrokerInitString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 81:
    flag = _wrap_helicsFederateInfoSetCoreType (resc, resv, argc, (mxArray **)(argv));
    break;
  case 82:
    flag = _wrap_helicsFederateInfoSetCoreTypeFromString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 83:
    flag = _wrap_helicsFederateInfoSetBroker (resc, resv, argc, (mxArray **)(argv));
    break;
  case 84:
    flag = _wrap_helicsFederateInfoSetBrokerKey (resc, resv, argc, (mxArray **)(argv));
    break;
  case 85:
    flag = _wrap_helicsFederateInfoSetBrokerPort (resc, resv, argc, (mxArray **)(argv));
    break;
  case 86:
    flag = _wrap_helicsFederateInfoSetLocalPort (resc, resv, argc, (mxArray **)(argv));
    break;
  case 87:
    flag = _wrap_helicsGetPropertyIndex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 88:
    flag = _wrap_helicsGetOptionIndex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 89:
    flag = _wrap_helicsFederateInfoSetFlagOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 90:
    flag = _wrap_helicsFederateInfoSetSeparator (resc, resv, argc, (mxArray **)(argv));
    break;
  case 91:
    flag = _wrap_helicsFederateInfoSetTimeProperty (resc, resv, argc, (mxArray **)(argv));
    break;
  case 92:
    flag = _wrap_helicsFederateInfoSetIntegerProperty (resc, resv, argc, (mxArray **)(argv));
    break;
  case 93:
    flag = _wrap_helicsFederateRegisterInterfaces (resc, resv, argc, (mxArray **)(argv));
    break;
  case 94:
    flag = _wrap_helicsFederateFinalize (resc, resv, argc, (mxArray **)(argv));
    break;
  case 95:
    flag = _wrap_helicsFederateFinalizeAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 96:
    flag = _wrap_helicsFederateFinalizeComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 97:
    flag = _wrap_helicsFederateFree (resc, resv, argc, (mxArray **)(argv));
    break;
  case 98:
    flag = _wrap_helicsCloseLibrary (resc, resv, argc, (mxArray **)(argv));
    break;
  case 99:
    flag = _wrap_helicsFederateEnterInitializingMode (resc, resv, argc, (mxArray **)(argv));
    break;
  case 100:
    flag = _wrap_helicsFederateEnterInitializingModeAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 101:
    flag = _wrap_helicsFederateIsAsyncOperationCompleted (resc, resv, argc, (mxArray **)(argv));
    break;
  case 102:
    flag = _wrap_helicsFederateEnterInitializingModeComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 103:
    flag = _wrap_helicsFederateEnterExecutingMode (resc, resv, argc, (mxArray **)(argv));
    break;
  case 104:
    flag = _wrap_helicsFederateEnterExecutingModeAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 105:
    flag = _wrap_helicsFederateEnterExecutingModeComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 106:
    flag = _wrap_helicsFederateEnterExecutingModeIterative (resc, resv, argc, (mxArray **)(argv));
    break;
  case 107:
    flag = _wrap_helicsFederateEnterExecutingModeIterativeAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 108:
    flag = _wrap_helicsFederateEnterExecutingModeIterativeComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 109:
    flag = _wrap_helicsFederateGetState (resc, resv, argc, (mxArray **)(argv));
    break;
  case 110:
    flag = _wrap_helicsFederateGetCoreObject (resc, resv, argc, (mxArray **)(argv));
    break;
  case 111:
    flag = _wrap_helicsFederateRequestTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 112:
    flag = _wrap_helicsFederateRequestTimeAdvance (resc, resv, argc, (mxArray **)(argv));
    break;
  case 113:
    flag = _wrap_helicsFederateRequestNextStep (resc, resv, argc, (mxArray **)(argv));
    break;
  case 114:
    flag = _wrap_helicsFederateRequestTimeIterative (resc, resv, argc, (mxArray **)(argv));
    break;
  case 115:
    flag = _wrap_helicsFederateRequestTimeAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 116:
    flag = _wrap_helicsFederateRequestTimeComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 117:
    flag = _wrap_helicsFederateRequestTimeIterativeAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 118:
    flag = _wrap_helicsFederateRequestTimeIterativeComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 119:
    flag = _wrap_helicsFederateGetName (resc, resv, argc, (mxArray **)(argv));
    break;
  case 120:
    flag = _wrap_helicsFederateSetTimeProperty (resc, resv, argc, (mxArray **)(argv));
    break;
  case 121:
    flag = _wrap_helicsFederateSetFlagOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 122:
    flag = _wrap_helicsFederateSetSeparator (resc, resv, argc, (mxArray **)(argv));
    break;
  case 123:
    flag = _wrap_helicsFederateSetIntegerProperty (resc, resv, argc, (mxArray **)(argv));
    break;
  case 124:
    flag = _wrap_helicsFederateGetTimeProperty (resc, resv, argc, (mxArray **)(argv));
    break;
  case 125:
    flag = _wrap_helicsFederateGetFlagOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 126:
    flag = _wrap_helicsFederateGetIntegerProperty (resc, resv, argc, (mxArray **)(argv));
    break;
  case 127:
    flag = _wrap_helicsFederateGetCurrentTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 128:
    flag = _wrap_helicsFederateSetGlobal (resc, resv, argc, (mxArray **)(argv));
    break;
  case 129:
    flag = _wrap_helicsFederateSetLogFile (resc, resv, argc, (mxArray **)(argv));
    break;
  case 130:
    flag = _wrap_helicsFederateLogErrorMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 131:
    flag = _wrap_helicsFederateLogWarningMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 132:
    flag = _wrap_helicsFederateLogInfoMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 133:
    flag = _wrap_helicsFederateLogDebugMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 134:
    flag = _wrap_helicsFederateLogLevelMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 135:
    flag = _wrap_helicsCoreSetGlobal (resc, resv, argc, (mxArray **)(argv));
    break;
  case 136:
    flag = _wrap_helicsBrokerSetGlobal (resc, resv, argc, (mxArray **)(argv));
    break;
  case 137:
    flag = _wrap_helicsCoreSetLogFile (resc, resv, argc, (mxArray **)(argv));
    break;
  case 138:
    flag = _wrap_helicsBrokerSetLogFile (resc, resv, argc, (mxArray **)(argv));
    break;
  case 139:
    flag = _wrap_helicsCreateQuery (resc, resv, argc, (mxArray **)(argv));
    break;
  case 140:
    flag = _wrap_helicsQueryExecute (resc, resv, argc, (mxArray **)(argv));
    break;
  case 141:
    flag = _wrap_helicsQueryCoreExecute (resc, resv, argc, (mxArray **)(argv));
    break;
  case 142:
    flag = _wrap_helicsQueryBrokerExecute (resc, resv, argc, (mxArray **)(argv));
    break;
  case 143:
    flag = _wrap_helicsQueryExecuteAsync (resc, resv, argc, (mxArray **)(argv));
    break;
  case 144:
    flag = _wrap_helicsQueryExecuteComplete (resc, resv, argc, (mxArray **)(argv));
    break;
  case 145:
    flag = _wrap_helicsQueryIsCompleted (resc, resv, argc, (mxArray **)(argv));
    break;
  case 146:
    flag = _wrap_helicsQueryFree (resc, resv, argc, (mxArray **)(argv));
    break;
  case 147:
    flag = _wrap_helicsCleanupLibrary (resc, resv, argc, (mxArray **)(argv));
    break;
  case 148:
    flag = _wrap_helicsFederateRegisterSubscription (resc, resv, argc, (mxArray **)(argv));
    break;
  case 149:
    flag = _wrap_helicsFederateRegisterPublication (resc, resv, argc, (mxArray **)(argv));
    break;
  case 150:
    flag = _wrap_helicsFederateRegisterTypePublication (resc, resv, argc, (mxArray **)(argv));
    break;
  case 151:
    flag = _wrap_helicsFederateRegisterGlobalPublication (resc, resv, argc, (mxArray **)(argv));
    break;
  case 152:
    flag = _wrap_helicsFederateRegisterGlobalTypePublication (resc, resv, argc, (mxArray **)(argv));
    break;
  case 153:
    flag = _wrap_helicsFederateRegisterInput (resc, resv, argc, (mxArray **)(argv));
    break;
  case 154:
    flag = _wrap_helicsFederateRegisterTypeInput (resc, resv, argc, (mxArray **)(argv));
    break;
  case 155:
    flag = _wrap_helicsFederateRegisterGlobalInput (resc, resv, argc, (mxArray **)(argv));
    break;
  case 156:
    flag = _wrap_helicsFederateRegisterGlobalTypeInput (resc, resv, argc, (mxArray **)(argv));
    break;
  case 157:
    flag = _wrap_helicsFederateGetPublication (resc, resv, argc, (mxArray **)(argv));
    break;
  case 158:
    flag = _wrap_helicsFederateGetPublicationByIndex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 159:
    flag = _wrap_helicsFederateGetInput (resc, resv, argc, (mxArray **)(argv));
    break;
  case 160:
    flag = _wrap_helicsFederateGetInputByIndex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 161:
    flag = _wrap_helicsFederateGetSubscription (resc, resv, argc, (mxArray **)(argv));
    break;
  case 162:
    flag = _wrap_helicsFederateClearUpdates (resc, resv, argc, (mxArray **)(argv));
    break;
  case 163:
    flag = _wrap_helicsFederateRegisterFromPublicationJSON (resc, resv, argc, (mxArray **)(argv));
    break;
  case 164:
    flag = _wrap_helicsFederatePublishJSON (resc, resv, argc, (mxArray **)(argv));
    break;
  case 165:
    flag = _wrap_helicsPublicationPublishRaw (resc, resv, argc, (mxArray **)(argv));
    break;
  case 166:
    flag = _wrap_helicsPublicationPublishString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 167:
    flag = _wrap_helicsPublicationPublishInteger (resc, resv, argc, (mxArray **)(argv));
    break;
  case 168:
    flag = _wrap_helicsPublicationPublishBoolean (resc, resv, argc, (mxArray **)(argv));
    break;
  case 169:
    flag = _wrap_helicsPublicationPublishDouble (resc, resv, argc, (mxArray **)(argv));
    break;
  case 170:
    flag = _wrap_helicsPublicationPublishTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 171:
    flag = _wrap_helicsPublicationPublishChar (resc, resv, argc, (mxArray **)(argv));
    break;
  case 172:
    flag = _wrap_helicsPublicationPublishComplex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 173:
    flag = _wrap_helicsPublicationPublishVector (resc, resv, argc, (mxArray **)(argv));
    break;
  case 174:
    flag = _wrap_helicsPublicationPublishNamedPoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 175:
    flag = _wrap_helicsPublicationAddTarget (resc, resv, argc, (mxArray **)(argv));
    break;
  case 176:
    flag = _wrap_helicsInputAddTarget (resc, resv, argc, (mxArray **)(argv));
    break;
  case 177:
    flag = _wrap_helicsInputGetRawValueSize (resc, resv, argc, (mxArray **)(argv));
    break;
  case 178:
    flag = _wrap_helicsInputGetRawValue (resc, resv, argc, (mxArray **)(argv));
    break;
  case 179:
    flag = _wrap_helicsInputGetStringSize (resc, resv, argc, (mxArray **)(argv));
    break;
  case 180:
    flag = _wrap_helicsInputGetString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 181:
    flag = _wrap_helicsInputGetInteger (resc, resv, argc, (mxArray **)(argv));
    break;
  case 182:
    flag = _wrap_helicsInputGetBoolean (resc, resv, argc, (mxArray **)(argv));
    break;
  case 183:
    flag = _wrap_helicsInputGetDouble (resc, resv, argc, (mxArray **)(argv));
    break;
  case 184:
    flag = _wrap_helicsInputGetTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 185:
    flag = _wrap_helicsInputGetChar (resc, resv, argc, (mxArray **)(argv));
    break;
  case 186:
    flag = _wrap_helicsInputGetComplex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 187:
    flag = _wrap_helicsInputGetVectorSize (resc, resv, argc, (mxArray **)(argv));
    break;
  case 188:
    flag = _wrap_helicsInputGetVector (resc, resv, argc, (mxArray **)(argv));
    break;
  case 189:
    flag = _wrap_helicsInputGetNamedPoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 190:
    flag = _wrap_helicsInputSetDefaultRaw (resc, resv, argc, (mxArray **)(argv));
    break;
  case 191:
    flag = _wrap_helicsInputSetDefaultString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 192:
    flag = _wrap_helicsInputSetDefaultInteger (resc, resv, argc, (mxArray **)(argv));
    break;
  case 193:
    flag = _wrap_helicsInputSetDefaultBoolean (resc, resv, argc, (mxArray **)(argv));
    break;
  case 194:
    flag = _wrap_helicsInputSetDefaultTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 195:
    flag = _wrap_helicsInputSetDefaultChar (resc, resv, argc, (mxArray **)(argv));
    break;
  case 196:
    flag = _wrap_helicsInputSetDefaultDouble (resc, resv, argc, (mxArray **)(argv));
    break;
  case 197:
    flag = _wrap_helicsInputSetDefaultComplex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 198:
    flag = _wrap_helicsInputSetDefaultVector (resc, resv, argc, (mxArray **)(argv));
    break;
  case 199:
    flag = _wrap_helicsInputSetDefaultNamedPoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 200:
    flag = _wrap_helicsInputGetType (resc, resv, argc, (mxArray **)(argv));
    break;
  case 201:
    flag = _wrap_helicsInputGetPublicationType (resc, resv, argc, (mxArray **)(argv));
    break;
  case 202:
    flag = _wrap_helicsPublicationGetType (resc, resv, argc, (mxArray **)(argv));
    break;
  case 203:
    flag = _wrap_helicsInputGetKey (resc, resv, argc, (mxArray **)(argv));
    break;
  case 204:
    flag = _wrap_helicsSubscriptionGetKey (resc, resv, argc, (mxArray **)(argv));
    break;
  case 205:
    flag = _wrap_helicsPublicationGetKey (resc, resv, argc, (mxArray **)(argv));
    break;
  case 206:
    flag = _wrap_helicsInputGetUnits (resc, resv, argc, (mxArray **)(argv));
    break;
  case 207:
    flag = _wrap_helicsInputGetInjectionUnits (resc, resv, argc, (mxArray **)(argv));
    break;
  case 208:
    flag = _wrap_helicsInputGetExtractionUnits (resc, resv, argc, (mxArray **)(argv));
    break;
  case 209:
    flag = _wrap_helicsPublicationGetUnits (resc, resv, argc, (mxArray **)(argv));
    break;
  case 210:
    flag = _wrap_helicsInputGetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 211:
    flag = _wrap_helicsInputSetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 212:
    flag = _wrap_helicsPublicationGetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 213:
    flag = _wrap_helicsPublicationSetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 214:
    flag = _wrap_helicsInputGetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 215:
    flag = _wrap_helicsInputSetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 216:
    flag = _wrap_helicsPublicationGetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 217:
    flag = _wrap_helicsPublicationSetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 218:
    flag = _wrap_helicsInputIsUpdated (resc, resv, argc, (mxArray **)(argv));
    break;
  case 219:
    flag = _wrap_helicsInputLastUpdateTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 220:
    flag = _wrap_helicsInputClearUpdate (resc, resv, argc, (mxArray **)(argv));
    break;
  case 221:
    flag = _wrap_helicsFederateGetPublicationCount (resc, resv, argc, (mxArray **)(argv));
    break;
  case 222:
    flag = _wrap_helicsFederateGetInputCount (resc, resv, argc, (mxArray **)(argv));
    break;
  case 223:
    flag = _wrap_helicsFederateRegisterEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 224:
    flag = _wrap_helicsFederateRegisterGlobalEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 225:
    flag = _wrap_helicsFederateGetEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 226:
    flag = _wrap_helicsFederateGetEndpointByIndex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 227:
    flag = _wrap_helicsEndpointSetDefaultDestination (resc, resv, argc, (mxArray **)(argv));
    break;
  case 228:
    flag = _wrap_helicsEndpointGetDefaultDestination (resc, resv, argc, (mxArray **)(argv));
    break;
  case 229:
    flag = _wrap_helicsEndpointSendMessageRaw (resc, resv, argc, (mxArray **)(argv));
    break;
  case 230:
    flag = _wrap_helicsEndpointSendEventRaw (resc, resv, argc, (mxArray **)(argv));
    break;
  case 231:
    flag = _wrap_helicsEndpointSendMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 232:
    flag = _wrap_helicsEndpointSendMessageObject (resc, resv, argc, (mxArray **)(argv));
    break;
  case 233:
    flag = _wrap_helicsEndpointSubscribe (resc, resv, argc, (mxArray **)(argv));
    break;
  case 234:
    flag = _wrap_helicsFederateHasMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 235:
    flag = _wrap_helicsEndpointHasMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 236:
    flag = _wrap_helicsFederatePendingMessages (resc, resv, argc, (mxArray **)(argv));
    break;
  case 237:
    flag = _wrap_helicsEndpointPendingMessages (resc, resv, argc, (mxArray **)(argv));
    break;
  case 238:
    flag = _wrap_helicsEndpointGetMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 239:
    flag = _wrap_helicsEndpointGetMessageObject (resc, resv, argc, (mxArray **)(argv));
    break;
  case 240:
    flag = _wrap_helicsFederateGetMessage (resc, resv, argc, (mxArray **)(argv));
    break;
  case 241:
    flag = _wrap_helicsFederateGetMessageObject (resc, resv, argc, (mxArray **)(argv));
    break;
  case 242:
    flag = _wrap_helicsFederateCreateMessageObject (resc, resv, argc, (mxArray **)(argv));
    break;
  case 243:
    flag = _wrap_helicsFederateClearMessages (resc, resv, argc, (mxArray **)(argv));
    break;
  case 244:
    flag = _wrap_helicsEndpointClearMessages (resc, resv, argc, (mxArray **)(argv));
    break;
  case 245:
    flag = _wrap_helicsEndpointGetType (resc, resv, argc, (mxArray **)(argv));
    break;
  case 246:
    flag = _wrap_helicsEndpointGetName (resc, resv, argc, (mxArray **)(argv));
    break;
  case 247:
    flag = _wrap_helicsFederateGetEndpointCount (resc, resv, argc, (mxArray **)(argv));
    break;
  case 248:
    flag = _wrap_helicsEndpointGetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 249:
    flag = _wrap_helicsEndpointSetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 250:
    flag = _wrap_helicsEndpointSetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 251:
    flag = _wrap_helicsEndpointGetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 252:
    flag = _wrap_helicsMessageGetSource (resc, resv, argc, (mxArray **)(argv));
    break;
  case 253:
    flag = _wrap_helicsMessageGetDestination (resc, resv, argc, (mxArray **)(argv));
    break;
  case 254:
    flag = _wrap_helicsMessageGetOriginalSource (resc, resv, argc, (mxArray **)(argv));
    break;
  case 255:
    flag = _wrap_helicsMessageGetOriginalDestination (resc, resv, argc, (mxArray **)(argv));
    break;
  case 256:
    flag = _wrap_helicsMessageGetTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 257:
    flag = _wrap_helicsMessageGetString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 258:
    flag = _wrap_helicsMessageGetMessageID (resc, resv, argc, (mxArray **)(argv));
    break;
  case 259:
    flag = _wrap_helicsMessageCheckFlag (resc, resv, argc, (mxArray **)(argv));
    break;
  case 260:
    flag = _wrap_helicsMessageGetRawDataSize (resc, resv, argc, (mxArray **)(argv));
    break;
  case 261:
    flag = _wrap_helicsMessageGetRawData (resc, resv, argc, (mxArray **)(argv));
    break;
  case 262:
    flag = _wrap_helicsMessageIsValid (resc, resv, argc, (mxArray **)(argv));
    break;
  case 263:
    flag = _wrap_helicsMessageSetSource (resc, resv, argc, (mxArray **)(argv));
    break;
  case 264:
    flag = _wrap_helicsMessageSetDestination (resc, resv, argc, (mxArray **)(argv));
    break;
  case 265:
    flag = _wrap_helicsMessageSetOriginalSource (resc, resv, argc, (mxArray **)(argv));
    break;
  case 266:
    flag = _wrap_helicsMessageSetOriginalDestination (resc, resv, argc, (mxArray **)(argv));
    break;
  case 267:
    flag = _wrap_helicsMessageSetTime (resc, resv, argc, (mxArray **)(argv));
    break;
  case 268:
    flag = _wrap_helicsMessageReserve (resc, resv, argc, (mxArray **)(argv));
    break;
  case 269:
    flag = _wrap_helicsMessageSetMessageID (resc, resv, argc, (mxArray **)(argv));
    break;
  case 270:
    flag = _wrap_helicsMessageClearFlags (resc, resv, argc, (mxArray **)(argv));
    break;
  case 271:
    flag = _wrap_helicsMessageSetFlagOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 272:
    flag = _wrap_helicsMessageSetString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 273:
    flag = _wrap_helicsMessageSetData (resc, resv, argc, (mxArray **)(argv));
    break;
  case 274:
    flag = _wrap_helicsMessageAppendData (resc, resv, argc, (mxArray **)(argv));
    break;
  case 275:
    flag = _wrap_helicsFederateRegisterFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 276:
    flag = _wrap_helicsFederateRegisterGlobalFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 277:
    flag = _wrap_helicsFederateRegisterCloningFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 278:
    flag = _wrap_helicsFederateRegisterGlobalCloningFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 279:
    flag = _wrap_helicsCoreRegisterFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 280:
    flag = _wrap_helicsCoreRegisterCloningFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 281:
    flag = _wrap_helicsFederateGetFilterCount (resc, resv, argc, (mxArray **)(argv));
    break;
  case 282:
    flag = _wrap_helicsFederateGetFilter (resc, resv, argc, (mxArray **)(argv));
    break;
  case 283:
    flag = _wrap_helicsFederateGetFilterByIndex (resc, resv, argc, (mxArray **)(argv));
    break;
  case 284:
    flag = _wrap_helicsFilterGetName (resc, resv, argc, (mxArray **)(argv));
    break;
  case 285:
    flag = _wrap_helicsFilterSet (resc, resv, argc, (mxArray **)(argv));
    break;
  case 286:
    flag = _wrap_helicsFilterSetString (resc, resv, argc, (mxArray **)(argv));
    break;
  case 287:
    flag = _wrap_helicsFilterAddDestinationTarget (resc, resv, argc, (mxArray **)(argv));
    break;
  case 288:
    flag = _wrap_helicsFilterAddSourceTarget (resc, resv, argc, (mxArray **)(argv));
    break;
  case 289:
    flag = _wrap_helicsFilterAddDeliveryEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 290:
    flag = _wrap_helicsFilterRemoveTarget (resc, resv, argc, (mxArray **)(argv));
    break;
  case 291:
    flag = _wrap_helicsFilterRemoveDeliveryEndpoint (resc, resv, argc, (mxArray **)(argv));
    break;
  case 292:
    flag = _wrap_helicsFilterGetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 293:
    flag = _wrap_helicsFilterSetInfo (resc, resv, argc, (mxArray **)(argv));
    break;
  case 294:
    flag = _wrap_helicsFilterSetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  case 295:
    flag = _wrap_helicsFilterGetOption (resc, resv, argc, (mxArray **)(argv));
    break;
  default:
