    ...
    if (newmemory == SWIG_CAST_NEW_MEMORY)
    {
        ...
        else
        {
            ...
            mexErrMsgIdAndTxt ("SWIG:ConvertPointerObj",
                               "SWIG error in converting pointer for type %s. Bad typemap?", type->name);
            return SWIG_ERROR;
        }
    }
    return SWIG_OK;
...
SWIGINTERN int swigConstant (int SWIGUNUSEDPARM (resc), mxArray *resv[], int argc, mxArray *argv[])
{
    ...
    case 31:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_flag_wait_for_current_time_update",
    ...
    case 39:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_flag_ignore_time_mismatch_warnings",
    ...
    case 75:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_connection_required",
                                   SWIG_From_int (static_cast<int> (helics_handle_option_connection_required)));
        ;
        break;
    case 76:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_connection_optional",
    ...
    case 80:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_strict_type_checking",
                                   SWIG_From_int (static_cast<int> (helics_handle_option_strict_type_checking)));
        ;
        break;
    case 81:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_ignore_unit_mismatch",
                                   SWIG_From_int (static_cast<int> (helics_handle_option_ignore_unit_mismatch)));
        ;
        break;
    case 82:
        *resv = SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_only_transmit_on_change",
                                         SWIG_From_int (
                                           static_cast<int> (helics_handle_option_only_transmit_on_change)));
        ;
        break;
    case 83:
        *resv =
    ...
    case 84:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_handle_option_ignore_interrupts",
    ...
    case 93:
        *resv =
          SWIG_Matlab_SetConstant (module_ns, "helics_iteration_request_force_iteration",
...
extern "C" void mexFunction (int resc, mxArray *resv[], int argc, const mxArray *argv[])
{
    ...
    if (--argc < 0 || !mxIsDouble (*argv) || mxGetNumberOfElements (*argv) != 1)
        mexErrMsgTxt ("This mex file should only be called from inside the .m files generated by SWIG. First "
                      "input should be the function ID .");
    int fcn_id = (int)mxGetScalar (*argv++);
    int flag = 0;
    switch (fcn_id)
    {
