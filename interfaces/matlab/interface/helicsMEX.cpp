...
SWIGINTERN const char* SwigConstantName(int con_id) {
  ...
  case 42: return "HELICS_FLAG_LOCAL_PROFILING_CAPTURE";
  case 43: return "HELICS_FLAG_DELAY_INIT_ENTRY";
  case 44: return "HELICS_FLAG_ENABLE_INIT_ENTRY";
  case 45: return "HELICS_FLAG_SLOW_RESPONDING";
  case 46: return "HELICS_FLAG_DEBUGGING";
  case 47: return "HELICS_FLAG_TERMINATE_ON_ERROR";
  case 48: return "HELICS_FLAG_FORCE_LOGGING_FLUSH";
  case 49: return "HELICS_FLAG_DUMPLOG";
  case 50: return "HELICS_FLAG_PROFILING";
  case 51: return "HELICS_FLAG_PROFILING_MARKER";
  case 52: return "HELICS_LOG_LEVEL_NO_PRINT";
  case 53: return "HELICS_LOG_LEVEL_ERROR";
  case 54: return "HELICS_LOG_LEVEL_PROFILING";
  case 55: return "HELICS_LOG_LEVEL_WARNING";
  case 56: return "HELICS_LOG_LEVEL_SUMMARY";
  case 57: return "HELICS_LOG_LEVEL_CONNECTIONS";
  case 58: return "HELICS_LOG_LEVEL_INTERFACES";
  case 59: return "HELICS_LOG_LEVEL_TIMING";
  case 60: return "HELICS_LOG_LEVEL_DATA";
  case 61: return "HELICS_LOG_LEVEL_DEBUG";
  case 62: return "HELICS_LOG_LEVEL_TRACE";
  case 63: return "HELICS_ERROR_FATAL";
  case 64: return "HELICS_ERROR_EXTERNAL_TYPE";
  case 65: return "HELICS_ERROR_OTHER";
  case 66: return "HELICS_ERROR_USER_ABORT";
  case 67: return "HELICS_ERROR_INSUFFICIENT_SPACE";
  case 68: return "HELICS_ERROR_EXECUTION_FAILURE";
  case 69: return "HELICS_ERROR_INVALID_FUNCTION_CALL";
  case 70: return "HELICS_ERROR_INVALID_STATE_TRANSITION";
  case 71: return "HELICS_WARNING";
  case 72: return "HELICS_ERROR_SYSTEM_FAILURE";
  case 73: return "HELICS_ERROR_DISCARD";
  case 74: return "HELICS_ERROR_INVALID_ARGUMENT";
  case 75: return "HELICS_ERROR_INVALID_OBJECT";
  case 76: return "HELICS_ERROR_CONNECTION_FAILURE";
  case 77: return "HELICS_ERROR_REGISTRATION_FAILURE";
  case 78: return "HELICS_OK";
  case 79: return "HELICS_PROPERTY_TIME_DELTA";
  case 80: return "HELICS_PROPERTY_TIME_PERIOD";
  case 81: return "HELICS_PROPERTY_TIME_OFFSET";
  case 82: return "HELICS_PROPERTY_TIME_RT_LAG";
  case 83: return "HELICS_PROPERTY_TIME_RT_LEAD";
  case 84: return "HELICS_PROPERTY_TIME_RT_TOLERANCE";
  case 85: return "HELICS_PROPERTY_TIME_INPUT_DELAY";
  case 86: return "HELICS_PROPERTY_TIME_OUTPUT_DELAY";
  case 87: return "HELICS_PROPERTY_INT_MAX_ITERATIONS";
  case 88: return "HELICS_PROPERTY_INT_LOG_LEVEL";
  case 89: return "HELICS_PROPERTY_INT_FILE_LOG_LEVEL";
  case 90: return "HELICS_PROPERTY_INT_CONSOLE_LOG_LEVEL";
  case 91: return "HELICS_MULTI_INPUT_NO_OP";
  case 92: return "HELICS_MULTI_INPUT_VECTORIZE_OPERATION";
  case 93: return "HELICS_MULTI_INPUT_AND_OPERATION";
  case 94: return "HELICS_MULTI_INPUT_OR_OPERATION";
  case 95: return "HELICS_MULTI_INPUT_SUM_OPERATION";
  case 96: return "HELICS_MULTI_INPUT_DIFF_OPERATION";
  case 97: return "HELICS_MULTI_INPUT_MAX_OPERATION";
  case 98: return "HELICS_MULTI_INPUT_MIN_OPERATION";
  case 99: return "HELICS_MULTI_INPUT_AVERAGE_OPERATION";
  case 100: return "HELICS_HANDLE_OPTION_CONNECTION_REQUIRED";
  case 101: return "HELICS_HANDLE_OPTION_CONNECTION_OPTIONAL";
  case 102: return "HELICS_HANDLE_OPTION_SINGLE_CONNECTION_ONLY";
  case 103: return "HELICS_HANDLE_OPTION_MULTIPLE_CONNECTIONS_ALLOWED";
  case 104: return "HELICS_HANDLE_OPTION_BUFFER_DATA";
  case 105: return "HELICS_HANDLE_OPTION_STRICT_TYPE_CHECKING";
  case 106: return "HELICS_HANDLE_OPTION_IGNORE_UNIT_MISMATCH";
  case 107: return "HELICS_HANDLE_OPTION_ONLY_TRANSMIT_ON_CHANGE";
  case 108: return "HELICS_HANDLE_OPTION_ONLY_UPDATE_ON_CHANGE";
  case 109: return "HELICS_HANDLE_OPTION_IGNORE_INTERRUPTS";
  case 110: return "HELICS_HANDLE_OPTION_MULTI_INPUT_HANDLING_METHOD";
  case 111: return "HELICS_HANDLE_OPTION_INPUT_PRIORITY_LOCATION";
  case 112: return "HELICS_HANDLE_OPTION_CLEAR_PRIORITY_LIST";
  case 113: return "HELICS_HANDLE_OPTION_CONNECTIONS";
  case 114: return "HELICS_FILTER_TYPE_CUSTOM";
  case 115: return "HELICS_FILTER_TYPE_DELAY";
  case 116: return "HELICS_FILTER_TYPE_RANDOM_DELAY";
  case 117: return "HELICS_FILTER_TYPE_RANDOM_DROP";
  case 118: return "HELICS_FILTER_TYPE_REROUTE";
  case 119: return "HELICS_FILTER_TYPE_CLONE";
  case 120: return "HELICS_FILTER_TYPE_FIREWALL";
  case 121: return "HELICS_SEQUENCING_MODE_FAST";
  case 122: return "HELICS_SEQUENCING_MODE_ORDERED";
  case 123: return "HELICS_ITERATION_REQUEST_NO_ITERATION";
  case 124: return "HELICS_ITERATION_REQUEST_FORCE_ITERATION";
  case 125: return "HELICS_ITERATION_REQUEST_ITERATE_IF_NEEDED";
  case 126: return "HELICS_ITERATION_RESULT_NEXT_STEP";
  case 127: return "HELICS_ITERATION_RESULT_ERROR";
  case 128: return "HELICS_ITERATION_RESULT_HALTED";
  case 129: return "HELICS_ITERATION_RESULT_ITERATING";
  case 130: return "HELICS_STATE_STARTUP";
  case 131: return "HELICS_STATE_INITIALIZATION";
  case 132: return "HELICS_STATE_EXECUTION";
  case 133: return "HELICS_STATE_FINALIZE";
  case 134: return "HELICS_STATE_ERROR";
  case 135: return "HELICS_STATE_PENDING_INIT";
  case 136: return "HELICS_STATE_PENDING_EXEC";
  case 137: return "HELICS_STATE_PENDING_TIME";
  case 138: return "HELICS_STATE_PENDING_ITERATIVE_TIME";
  case 139: return "HELICS_STATE_PENDING_FINALIZE";
  case 140: return "HELICS_STATE_FINISHED";
  default: return 0;
  }
}
...
SWIGINTERN int swigConstant(int SWIGUNUSEDPARM(resc), mxArray *resv[], int argc, mxArray *argv[]) {
  ...
  case 42: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_LOCAL_PROFILING_CAPTURE",SWIG_From_int(static_cast< int >(HELICS_FLAG_LOCAL_PROFILING_CAPTURE)));; break;
  case 43: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_DELAY_INIT_ENTRY",SWIG_From_int(static_cast< int >(HELICS_FLAG_DELAY_INIT_ENTRY)));; break;
  case 44: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_ENABLE_INIT_ENTRY",SWIG_From_int(static_cast< int >(HELICS_FLAG_ENABLE_INIT_ENTRY)));; break;
  case 45: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_SLOW_RESPONDING",SWIG_From_int(static_cast< int >(HELICS_FLAG_SLOW_RESPONDING)));; break;
  case 46: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_DEBUGGING",SWIG_From_int(static_cast< int >(HELICS_FLAG_DEBUGGING)));; break;
  case 47: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_TERMINATE_ON_ERROR",SWIG_From_int(static_cast< int >(HELICS_FLAG_TERMINATE_ON_ERROR)));; break;
  case 48: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_FORCE_LOGGING_FLUSH",SWIG_From_int(static_cast< int >(HELICS_FLAG_FORCE_LOGGING_FLUSH)));; break;
  case 49: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_DUMPLOG",SWIG_From_int(static_cast< int >(HELICS_FLAG_DUMPLOG)));; break;
  case 50: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_PROFILING",SWIG_From_int(static_cast< int >(HELICS_FLAG_PROFILING)));; break;
  case 51: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FLAG_PROFILING_MARKER",SWIG_From_int(static_cast< int >(HELICS_FLAG_PROFILING_MARKER)));; break;
  case 52: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_NO_PRINT",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_NO_PRINT)));; break;
  case 53: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_ERROR",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_ERROR)));; break;
  case 54: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_PROFILING",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_PROFILING)));; break;
  case 55: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_WARNING",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_WARNING)));; break;
  case 56: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_SUMMARY",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_SUMMARY)));; break;
  case 57: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_CONNECTIONS",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_CONNECTIONS)));; break;
  case 58: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_INTERFACES",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_INTERFACES)));; break;
  case 59: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_TIMING",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_TIMING)));; break;
  case 60: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_DATA",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_DATA)));; break;
  case 61: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_DEBUG",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_DEBUG)));; break;
  case 62: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_LOG_LEVEL_TRACE",SWIG_From_int(static_cast< int >(HELICS_LOG_LEVEL_TRACE)));; break;
  case 63: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_FATAL",SWIG_From_int(static_cast< int >(HELICS_ERROR_FATAL)));; break;
  ...
  case 65: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_OTHER",SWIG_From_int(static_cast< int >(HELICS_ERROR_OTHER)));; break;
  case 66: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_USER_ABORT",SWIG_From_int(static_cast< int >(HELICS_ERROR_USER_ABORT)));; break;
  case 67: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_INSUFFICIENT_SPACE",SWIG_From_int(static_cast< int >(HELICS_ERROR_INSUFFICIENT_SPACE)));; break;
  case 68: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_EXECUTION_FAILURE",SWIG_From_int(static_cast< int >(HELICS_ERROR_EXECUTION_FAILURE)));; break;
  case 69: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_INVALID_FUNCTION_CALL",SWIG_From_int(static_cast< int >(HELICS_ERROR_INVALID_FUNCTION_CALL)));; break;
  case 70: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_INVALID_STATE_TRANSITION",SWIG_From_int(static_cast< int >(HELICS_ERROR_INVALID_STATE_TRANSITION)));; break;
  case 71: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_WARNING",SWIG_From_int(static_cast< int >(HELICS_WARNING)));; break;
  case 72: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_SYSTEM_FAILURE",SWIG_From_int(static_cast< int >(HELICS_ERROR_SYSTEM_FAILURE)));; break;
  case 73: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_DISCARD",SWIG_From_int(static_cast< int >(HELICS_ERROR_DISCARD)));; break;
  case 74: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_INVALID_ARGUMENT",SWIG_From_int(static_cast< int >(HELICS_ERROR_INVALID_ARGUMENT)));; break;
  case 75: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_INVALID_OBJECT",SWIG_From_int(static_cast< int >(HELICS_ERROR_INVALID_OBJECT)));; break;
  case 76: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_CONNECTION_FAILURE",SWIG_From_int(static_cast< int >(HELICS_ERROR_CONNECTION_FAILURE)));; break;
  case 77: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ERROR_REGISTRATION_FAILURE",SWIG_From_int(static_cast< int >(HELICS_ERROR_REGISTRATION_FAILURE)));; break;
  case 78: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_OK",SWIG_From_int(static_cast< int >(HELICS_OK)));; break;
  case 79: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_DELTA",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_DELTA)));; break;
  case 80: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_PERIOD",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_PERIOD)));; break;
  case 81: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_OFFSET",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_OFFSET)));; break;
  case 82: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_RT_LAG",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_RT_LAG)));; break;
  case 83: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_RT_LEAD",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_RT_LEAD)));; break;
  case 84: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_RT_TOLERANCE",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_RT_TOLERANCE)));; break;
  case 85: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_INPUT_DELAY",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_INPUT_DELAY)));; break;
  case 86: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_TIME_OUTPUT_DELAY",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_TIME_OUTPUT_DELAY)));; break;
  case 87: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_INT_MAX_ITERATIONS",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_INT_MAX_ITERATIONS)));; break;
  case 88: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_INT_LOG_LEVEL",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_INT_LOG_LEVEL)));; break;
  case 89: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_INT_FILE_LOG_LEVEL",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_INT_FILE_LOG_LEVEL)));; break;
  case 90: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_PROPERTY_INT_CONSOLE_LOG_LEVEL",SWIG_From_int(static_cast< int >(HELICS_PROPERTY_INT_CONSOLE_LOG_LEVEL)));; break;
  case 91: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_NO_OP",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_NO_OP)));; break;
  case 92: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_VECTORIZE_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_VECTORIZE_OPERATION)));; break;
  case 93: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_AND_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_AND_OPERATION)));; break;
  case 94: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_OR_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_OR_OPERATION)));; break;
  case 95: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_SUM_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_SUM_OPERATION)));; break;
  case 96: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_DIFF_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_DIFF_OPERATION)));; break;
  case 97: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_MAX_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_MAX_OPERATION)));; break;
  case 98: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_MIN_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_MIN_OPERATION)));; break;
  case 99: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_MULTI_INPUT_AVERAGE_OPERATION",SWIG_From_int(static_cast< int >(HELICS_MULTI_INPUT_AVERAGE_OPERATION)));; break;
  case 100: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_CONNECTION_REQUIRED",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_CONNECTION_REQUIRED)));; break;
  case 101: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_CONNECTION_OPTIONAL",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_CONNECTION_OPTIONAL)));; break;
  case 102: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_SINGLE_CONNECTION_ONLY",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_SINGLE_CONNECTION_ONLY)));; break;
  case 103: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_MULTIPLE_CONNECTIONS_ALLOWED",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_MULTIPLE_CONNECTIONS_ALLOWED)));; break;
  case 104: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_BUFFER_DATA",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_BUFFER_DATA)));; break;
  case 105: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_STRICT_TYPE_CHECKING",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_STRICT_TYPE_CHECKING)));; break;
  case 106: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_IGNORE_UNIT_MISMATCH",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_IGNORE_UNIT_MISMATCH)));; break;
  case 107: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_ONLY_TRANSMIT_ON_CHANGE",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_ONLY_TRANSMIT_ON_CHANGE)));; break;
  case 108: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_ONLY_UPDATE_ON_CHANGE",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_ONLY_UPDATE_ON_CHANGE)));; break;
  case 109: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_IGNORE_INTERRUPTS",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_IGNORE_INTERRUPTS)));; break;
  case 110: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_MULTI_INPUT_HANDLING_METHOD",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_MULTI_INPUT_HANDLING_METHOD)));; break;
  case 111: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_INPUT_PRIORITY_LOCATION",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_INPUT_PRIORITY_LOCATION)));; break;
  case 112: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_CLEAR_PRIORITY_LIST",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_CLEAR_PRIORITY_LIST)));; break;
  case 113: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_HANDLE_OPTION_CONNECTIONS",SWIG_From_int(static_cast< int >(HELICS_HANDLE_OPTION_CONNECTIONS)));; break;
  case 114: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_CUSTOM",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_CUSTOM)));; break;
  case 115: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_DELAY",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_DELAY)));; break;
  case 116: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_RANDOM_DELAY",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_RANDOM_DELAY)));; break;
  case 117: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_RANDOM_DROP",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_RANDOM_DROP)));; break;
  case 118: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_REROUTE",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_REROUTE)));; break;
  case 119: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_CLONE",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_CLONE)));; break;
  case 120: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_FILTER_TYPE_FIREWALL",SWIG_From_int(static_cast< int >(HELICS_FILTER_TYPE_FIREWALL)));; break;
  case 121: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_SEQUENCING_MODE_FAST",SWIG_From_int(static_cast< int >(HELICS_SEQUENCING_MODE_FAST)));; break;
  case 122: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_SEQUENCING_MODE_ORDERED",SWIG_From_int(static_cast< int >(HELICS_SEQUENCING_MODE_ORDERED)));; break;
  case 123: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_REQUEST_NO_ITERATION",SWIG_From_int(static_cast< int >(HELICS_ITERATION_REQUEST_NO_ITERATION)));; break;
  case 124: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_REQUEST_FORCE_ITERATION",SWIG_From_int(static_cast< int >(HELICS_ITERATION_REQUEST_FORCE_ITERATION)));; break;
  case 125: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_REQUEST_ITERATE_IF_NEEDED",SWIG_From_int(static_cast< int >(HELICS_ITERATION_REQUEST_ITERATE_IF_NEEDED)));; break;
  case 126: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_RESULT_NEXT_STEP",SWIG_From_int(static_cast< int >(HELICS_ITERATION_RESULT_NEXT_STEP)));; break;
  case 127: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_RESULT_ERROR",SWIG_From_int(static_cast< int >(HELICS_ITERATION_RESULT_ERROR)));; break;
  case 128: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_RESULT_HALTED",SWIG_From_int(static_cast< int >(HELICS_ITERATION_RESULT_HALTED)));; break;
  case 129: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_ITERATION_RESULT_ITERATING",SWIG_From_int(static_cast< int >(HELICS_ITERATION_RESULT_ITERATING)));; break;
  case 130: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_STARTUP",SWIG_From_int(static_cast< int >(HELICS_STATE_STARTUP)));; break;
  case 131: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_INITIALIZATION",SWIG_From_int(static_cast< int >(HELICS_STATE_INITIALIZATION)));; break;
  case 132: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_EXECUTION",SWIG_From_int(static_cast< int >(HELICS_STATE_EXECUTION)));; break;
  case 133: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_FINALIZE",SWIG_From_int(static_cast< int >(HELICS_STATE_FINALIZE)));; break;
  case 134: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_ERROR",SWIG_From_int(static_cast< int >(HELICS_STATE_ERROR)));; break;
  case 135: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_PENDING_INIT",SWIG_From_int(static_cast< int >(HELICS_STATE_PENDING_INIT)));; break;
  case 136: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_PENDING_EXEC",SWIG_From_int(static_cast< int >(HELICS_STATE_PENDING_EXEC)));; break;
  case 137: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_PENDING_TIME",SWIG_From_int(static_cast< int >(HELICS_STATE_PENDING_TIME)));; break;
  case 138: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_PENDING_ITERATIVE_TIME",SWIG_From_int(static_cast< int >(HELICS_STATE_PENDING_ITERATIVE_TIME)));; break;
  case 139: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_PENDING_FINALIZE",SWIG_From_int(static_cast< int >(HELICS_STATE_PENDING_FINALIZE)));; break;
  case 140: *resv = SWIG_Matlab_SetConstant(module_ns,"HELICS_STATE_FINISHED",SWIG_From_int(static_cast< int >(HELICS_STATE_FINISHED)));; break;
  default:
