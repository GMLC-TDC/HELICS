...
public class helics implements helicsConstants {
  ...
  public static helics_status helicsBrokerGetIdentifier(SWIGTYPE_p_void broker, String identifier, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsBrokerGetIdentifier(SWIGTYPE_p_void.getCPtr(broker), identifier, maxlen));
  }

  public static helics_status helicsCoreGetIdentifier(SWIGTYPE_p_void core, String identifier, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsCoreGetIdentifier(SWIGTYPE_p_void.getCPtr(core), identifier, maxlen));
  }

  public static helics_status helicsBrokerGetAddress(SWIGTYPE_p_void broker, String address, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsBrokerGetAddress(SWIGTYPE_p_void.getCPtr(broker), address, maxlen));
  }
  ...
  public static helics_status helicsFederateInfoLoadFromArgs(SWIGTYPE_p_void fi, int argc, SWIGTYPE_p_p_char argv) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateInfoLoadFromArgs(SWIGTYPE_p_void.getCPtr(fi), argc, SWIGTYPE_p_p_char.getCPtr(argv)));
  }
  ...
  public static helics_status helicsFederateEnterExecutionModeIterative(SWIGTYPE_p_void fed, helics_iteration_request iterate, SWIGTYPE_p_helics_iteration_status outIterate) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateEnterExecutionModeIterative(SWIGTYPE_p_void.getCPtr(fed), iterate.swigValue(), SWIGTYPE_p_helics_iteration_status.getCPtr(outIterate)));
  }
  ...
  public static helics_status helicsFederateEnterExecutionModeIterativeComplete(SWIGTYPE_p_void fed, SWIGTYPE_p_helics_iteration_status outIterate) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateEnterExecutionModeIterativeComplete(SWIGTYPE_p_void.getCPtr(fed), SWIGTYPE_p_helics_iteration_status.getCPtr(outIterate)));
  }

  public static helics_status helicsFederateGetState(SWIGTYPE_p_void fed, SWIGTYPE_p_federate_state state) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateGetState(SWIGTYPE_p_void.getCPtr(fed), SWIGTYPE_p_federate_state.getCPtr(state)));
  }
  ...
  public static helics_status helicsFederateRequestTime(SWIGTYPE_p_void fed, double requestTime, SWIGTYPE_p_double timeOut) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateRequestTime(SWIGTYPE_p_void.getCPtr(fed), requestTime, SWIGTYPE_p_double.getCPtr(timeOut)));
  }

  public static helics_status helicsFederateRequestTimeIterative(SWIGTYPE_p_void fed, double requestTime, helics_iteration_request iterate, SWIGTYPE_p_double timeOut, SWIGTYPE_p_helics_iteration_status outIterate) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateRequestTimeIterative(SWIGTYPE_p_void.getCPtr(fed), requestTime, iterate.swigValue(), SWIGTYPE_p_double.getCPtr(timeOut), SWIGTYPE_p_helics_iteration_status.getCPtr(outIterate)));
  }
  ...
  public static helics_status helicsFederateRequestTimeComplete(SWIGTYPE_p_void fed, SWIGTYPE_p_double timeOut) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateRequestTimeComplete(SWIGTYPE_p_void.getCPtr(fed), SWIGTYPE_p_double.getCPtr(timeOut)));
  }
  ...
  public static helics_status helicsFederateRequestTimeIterativeComplete(SWIGTYPE_p_void fed, SWIGTYPE_p_double timeOut, SWIGTYPE_p_helics_iteration_status outIterate) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateRequestTimeIterativeComplete(SWIGTYPE_p_void.getCPtr(fed), SWIGTYPE_p_double.getCPtr(timeOut), SWIGTYPE_p_helics_iteration_status.getCPtr(outIterate)));
  }

  public static helics_status helicsFederateGetName(SWIGTYPE_p_void fed, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateGetName(SWIGTYPE_p_void.getCPtr(fed), str, maxlen));
  }
  ...
  public static helics_status helicsFederateGetCurrentTime(SWIGTYPE_p_void fed, SWIGTYPE_p_double time) {
    return helics_status.swigToEnum(helicsJNI.helicsFederateGetCurrentTime(SWIGTYPE_p_void.getCPtr(fed), SWIGTYPE_p_double.getCPtr(time)));
  }
  ...
  public static helics_status helicsPublicationPublish(SWIGTYPE_p_void pub, String data, int len) {
    return helics_status.swigToEnum(helicsJNI.helicsPublicationPublish(SWIGTYPE_p_void.getCPtr(pub), data, len));
  }
  ...
  public static helics_status helicsPublicationPublishInteger(SWIGTYPE_p_void pub, SWIGTYPE_p_int64_t val) {
    return helics_status.swigToEnum(helicsJNI.helicsPublicationPublishInteger(SWIGTYPE_p_void.getCPtr(pub), SWIGTYPE_p_int64_t.getCPtr(val)));
  }
  ...
  public static helics_status helicsPublicationPublishVector(SWIGTYPE_p_void pub, SWIGTYPE_p_double data, int len) {
    return helics_status.swigToEnum(helicsJNI.helicsPublicationPublishVector(SWIGTYPE_p_void.getCPtr(pub), SWIGTYPE_p_double.getCPtr(data), len));
  }
  ...
  public static helics_status helicsSubscriptionGetValue(SWIGTYPE_p_void sub, String data, int maxlen, SWIGTYPE_p_int actualLength) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetValue(SWIGTYPE_p_void.getCPtr(sub), data, maxlen, SWIGTYPE_p_int.getCPtr(actualLength)));
  }

  public static helics_status helicsSubscriptionGetString(SWIGTYPE_p_void sub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetString(SWIGTYPE_p_void.getCPtr(sub), str, maxlen));
  }

  public static helics_status helicsSubscriptionGetInteger(SWIGTYPE_p_void sub, SWIGTYPE_p_int64_t val) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetInteger(SWIGTYPE_p_void.getCPtr(sub), SWIGTYPE_p_int64_t.getCPtr(val)));
  }

  public static helics_status helicsSubscriptionGetDouble(SWIGTYPE_p_void sub, SWIGTYPE_p_double val) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetDouble(SWIGTYPE_p_void.getCPtr(sub), SWIGTYPE_p_double.getCPtr(val)));
  }

  public static helics_status helicsSubscriptionGetComplex(SWIGTYPE_p_void sub, SWIGTYPE_p_double real, SWIGTYPE_p_double imag) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetComplex(SWIGTYPE_p_void.getCPtr(sub), SWIGTYPE_p_double.getCPtr(real), SWIGTYPE_p_double.getCPtr(imag)));
  }
  ...
  public static helics_status helicsSubscriptionGetVector(SWIGTYPE_p_void sub, SWIGTYPE_p_double data, int maxlen, SWIGTYPE_p_int actualSize) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetVector(SWIGTYPE_p_void.getCPtr(sub), SWIGTYPE_p_double.getCPtr(data), maxlen, SWIGTYPE_p_int.getCPtr(actualSize)));
  }

  public static helics_status helicsSubscriptionSetDefault(SWIGTYPE_p_void sub, String data, int len) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionSetDefault(SWIGTYPE_p_void.getCPtr(sub), data, len));
  }
  ...
  public static helics_status helicsSubscriptionSetDefaultInteger(SWIGTYPE_p_void sub, SWIGTYPE_p_int64_t val) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionSetDefaultInteger(SWIGTYPE_p_void.getCPtr(sub), SWIGTYPE_p_int64_t.getCPtr(val)));
  }
  ...
  public static helics_status helicsSubscriptionSetDefaultVector(SWIGTYPE_p_void sub, SWIGTYPE_p_double data, int len) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionSetDefaultVector(SWIGTYPE_p_void.getCPtr(sub), SWIGTYPE_p_double.getCPtr(data), len));
  }

  public static helics_status helicsSubscriptionGetType(SWIGTYPE_p_void sub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetType(SWIGTYPE_p_void.getCPtr(sub), str, maxlen));
  }

  public static helics_status helicsPublicationGetType(SWIGTYPE_p_void pub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsPublicationGetType(SWIGTYPE_p_void.getCPtr(pub), str, maxlen));
  }

  public static helics_status helicsSubscriptionGetKey(SWIGTYPE_p_void sub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetKey(SWIGTYPE_p_void.getCPtr(sub), str, maxlen));
  }

  public static helics_status helicsPublicationGetKey(SWIGTYPE_p_void pub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsPublicationGetKey(SWIGTYPE_p_void.getCPtr(pub), str, maxlen));
  }

  public static helics_status helicsSubscriptionGetUnits(SWIGTYPE_p_void sub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsSubscriptionGetUnits(SWIGTYPE_p_void.getCPtr(sub), str, maxlen));
  }

  public static helics_status helicsPublicationGetUnits(SWIGTYPE_p_void pub, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsPublicationGetUnits(SWIGTYPE_p_void.getCPtr(pub), str, maxlen));
  }
  ...
  public static helics_status helicsEndpointSendMessageRaw(SWIGTYPE_p_void endpoint, String dest, String data, int len) {
    return helics_status.swigToEnum(helicsJNI.helicsEndpointSendMessageRaw(SWIGTYPE_p_void.getCPtr(endpoint), dest, data, len));
  }

  public static helics_status helicsEndpointSendEventRaw(SWIGTYPE_p_void endpoint, String dest, String data, int len, double time) {
    return helics_status.swigToEnum(helicsJNI.helicsEndpointSendEventRaw(SWIGTYPE_p_void.getCPtr(endpoint), dest, data, len, time));
  }
  ...
  public static helics_status helicsEndpointGetType(SWIGTYPE_p_void endpoint, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsEndpointGetType(SWIGTYPE_p_void.getCPtr(endpoint), str, maxlen));
  }

  public static helics_status helicsEndpointGetName(SWIGTYPE_p_void endpoint, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsEndpointGetName(SWIGTYPE_p_void.getCPtr(endpoint), str, maxlen));
  }
  ...
  public static SWIGTYPE_p_void helicsCoreRegisterCloningFilter(SWIGTYPE_p_void fed, String deliveryEndpoint) {
    long cPtr = helicsJNI.helicsCoreRegisterCloningFilter(SWIGTYPE_p_void.getCPtr(fed), deliveryEndpoint);
    return (cPtr == 0) ? null : new SWIGTYPE_p_void(cPtr, false);
  }

  public static helics_status helicsFilterGetTarget(SWIGTYPE_p_void filt, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsFilterGetTarget(SWIGTYPE_p_void.getCPtr(filt), str, maxlen));
  }

  public static helics_status helicsFilterGetName(SWIGTYPE_p_void filt, String str, int maxlen) {
    return helics_status.swigToEnum(helicsJNI.helicsFilterGetName(SWIGTYPE_p_void.getCPtr(filt), str, maxlen));
  }
