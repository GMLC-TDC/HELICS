...
if(${PROJECT}_USE_ZMQ_STATIC_LIBRARY)
...
if(MINGW)
    set(${PROJECT}_LIBZMQ_VERSION v4.3.1)
else()
    set(${PROJECT}_LIBZMQ_VERSION v4.3.2)
endif()
...
if(NOT CMAKE_VERSION VERSION_LESS 3.11)
    ...
    fetchcontent_declare(
        ...
        GIT_TAG ${${PROJECT}_LIBZMQ_VERSION}
    )
...
if(${PROJECT}_BUILD_CXX_SHARED_LIB OR NOT ${PROJECT}_DISABLE_C_SHARED_LIB)

    if(NOT ${PROJECT}_USE_ZMQ_STATIC_LIBRARY)
        ...
        elseif(WIN32)
            ...
            message(
                WARNING
                    "Update to CMake 3.13+ or enable the ${PROJECT}_USE_ZMQ_STATIC_LIBRARY CMake option to install when using ZMQ as a subproject"
            )
        endif()
        if(MSVC
           AND NOT EMBEDDED_DEBUG_INFO
           AND NOT ${PROJECT}_BINARY_ONLY_INSTALL
        )
            install(
        ...
        if(MSVC AND NOT ${PROJECT}_BINARY_ONLY_INSTALL)
            install(
