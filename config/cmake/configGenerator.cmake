...
try_compile(SHARED_TIMED_MUTEX_AVAILABLE ${CMAKE_BINARY_DIR} ${TEST_CXX_DIRECTORY}/check_shared_timed_mutex.cpp OUTPUT_VARIABLE COMPILE_OUTPUT)
if (NOT SHARED_TIME_MUTEX)
message(STATUS "shared timed mutex failed ${COMPILE_OUTPUT}")
endif()
