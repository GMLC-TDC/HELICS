...
function(git_version_describe source_path result)
  ...
  if (GIT_FOUND)
	...
	if (TAGGING_ERROR)
		execute_process(COMMAND ${GIT_EXECUTABLE} -C ${source_path} --work-tree ${source_path} describe --all --tags --dirty OUTPUT_VARIABLE TAG_DESCRIPTION ERROR_VARIABLE TAGGING_ERROR OUTPUT_STRIP_TRAILING_WHITESPACE)
