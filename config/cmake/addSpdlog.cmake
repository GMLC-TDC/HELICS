...
if(${PROJECT_NAME}_USE_EXTERNAL_SPDLOG)
    # find spdlog somewhere on the system
    # NOTE/TODO: there may be odd corner cases when external spdlog depends on an
    # external fmt, but we tell HELICS to use the vendored copy of fmt
    # NOTE2: static spdlog should be built with CMAKE_POSITION_INDEPENDENT_CODE
    find_package(spdlog REQUIRED)
else()
    # the spdlog install internally stores whether it was built with this on
    # our vendored copy of spdlog should never use its own fmt
