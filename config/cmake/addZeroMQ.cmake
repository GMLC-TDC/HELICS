    ...
    if(NOT ZeroMQ_FOUND)
        ...
        if(NOT ZeroMQ_FOUND)
           if(ZMQ_SUBPROJECT)
			  ...
			  show_variable(ZeroMQ_DEBUG_LIBRARY)
			  show_variable(ZeroMQ_LIBRARY)
			  show_variable(ZeroMQ_ROOT_DIR)
			  show_variable(ZeroMQ_STATIC_LIBRARY)
			  show_variable(ZeroMQ_INCLUDE_DIR)
		   endif()
		endif()
    endif()
