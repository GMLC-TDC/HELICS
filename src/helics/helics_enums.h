 ...
 */
    typedef enum {/** don't print anything except a few catastrophic errors*/
                  ...
                  helics_log_level_trace = 7} helics_log_levels;
    ...
    typedef enum {
        ...
        /** integer property controlling the log level for file logging in a federate see \ref
           helics_log_levels*/
        helics_property_int_console_log_level = 274} helics_properties;
    ...
    typedef enum {
        ...
        helics_handle_option_connections = 522} helics_handle_options;
