...
int main(int argc, char* argv[])  // NOLINT
{
    ...
    auto* term =
        cmdLine
            .add_subcommand(
                "term",
                "HelicsBroker term <broker args...> will start a broker and open a terminal control window "
    ...
    cmdLine.add_flag(
        "--autorestart",
        autorestart,
        "HelicsBroker --autorestart <broker args ...> will start a continually regenerating broker "
    ...
    cmdLine
        .footer(
            "HelicsBroker <broker args ..> starts a broker with the given args and waits for it to "
            "complete\n")
        ->footer([]() {
