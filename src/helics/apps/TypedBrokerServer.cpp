...
namespace helics {
    namespace apps {
        ...
        static ActionMessage generatePortRequestReply(const ActionMessage& /*cmd*/, std::shared_ptr<Broker>& brk)
        {
            ...
            findBroker(const ActionMessage& rx, core_type ctype, int startPort)
        {
            ...
            std::string TypedBrokerServer::generateMessageResponse(const ActionMessage &rxcmd, portData &pdata)
            {
