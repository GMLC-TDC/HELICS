...
MultiBroker::MultiBroker () noexcept { loadComms (); }

MultiBroker::MultiBroker (int /*argc*/, char * /*argv*/[]) { loadComms (); }

MultiBroker::MultiBroker (const std::string & /*configFile*/) { loadComms (); }
...
void MultiBroker::brokerDisconnect () { commDisconnect (); }
...
bool MultiBroker::tryReconnect () { return masterComm->reconnect (); }

void MultiBroker::transmit (route_id rid, const ActionMessage &cmd) { masterComm->transmit (rid, cmd); }

void MultiBroker::transmit (route_id rid, ActionMessage &&cmd) { masterComm->transmit (rid, std::move (cmd)); }

void MultiBroker::addRoute (route_id rid, const std::string &routeInfo) { masterComm->addRoute (rid, routeInfo); }
