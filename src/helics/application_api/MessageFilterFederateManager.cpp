...
namespace helics
{
MessageFilterFederateManager::MessageFilterFederateManager (std::shared_ptr<Core> coreOb, Core::federate_id_t id)
...
filter_id_t MessageFilterFederateManager::registerSourceFilter (const std::string &filterName,
...
filter_id_t MessageFilterFederateManager::registerDestinationFilter (const std::string &filterName,
...
void MessageFilterFederateManager::registerFilterCallback (filter_id_t id,
...
void MessageFilterFederateManager::registerFilterCallback (const std::vector<filter_id_t> &ids,
                                                           std::function<void(filter_id_t, Time)> callback)
{
    std::lock_guard<std::mutex> fLock (filterLock);
...
void MessageFilterFederateManager::registerMessageOperator (const std::vector<filter_id_t> &filter_ids,
