...
public:
  ...
  */
  Input &
  registerGlobalInput (const std::string &key, const std::string &type, const std::string &units = std::string ());
...
*/
  template <typename X>
  Input &
  registerInputIndexed (const std::string &key, int index1, int index2, const std::string &units = std::string ())
  {
  ...
  */
  Input &registerSubscriptionIndexed (const std::string &target,
                                      ...
                                      const std::string &units = std::string ())
  {
    return registerSubscription (target + '_' + std::to_string (index1) + '_' + std::to_string (index2), units);
  }
