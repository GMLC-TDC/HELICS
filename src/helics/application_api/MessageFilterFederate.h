...
namespace helics
{
	...
	public:
		...
		*/
		MessageFilterFederate(const FederateInfo_app &fi);
	...
	public:
		...
		*/
		void registerFilterCallback(const std::vector<filter_id_t> &filters, std::function<void(filter_id_t,Time)> callback);
