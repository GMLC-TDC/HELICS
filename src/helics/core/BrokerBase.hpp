...
class BrokerBase {
  protected:
    ...
    /** the minimum number of direct local federates that must connect before entering init mode */
    int32_t minLocalFederateCount{0};
    /** the minimum number of direct child brokers that must connect before entering init mode */
    int32_t minLocalBrokerCount{0};
    /** federate names that must be registered before entering init mode */
