...
static const std::map<std::string, core_type> coreTypes{
  {"default", core_type::DEFAULT},  {"def", core_type::DEFAULT},
  {"mpi", core_type::MPI},          {"message_passing_interface", core_type::MPI},
  {"0mq", core_type::ZMQ},          {"zmq", core_type::ZMQ},
  {"zeromq", core_type::ZMQ},       {"interprocess", core_type::INTERPROCESS},
  {"ipc", core_type::INTERPROCESS}, {"interproc", core_type::INTERPROCESS},
  {"tcp", core_type::TCP},          {"tcpip", core_type::TCP},
  {"udp", core_type::UDP},          {"test", core_type::TEST},
  {"local", core_type::TEST},       {"inprocess", core_type::TEST},
