...
InterfaceHandle EmptyCore::getInput(LocalFederateId /*federateID*/, const std::string& /*key*/) const
{
    return {};
}
...
InterfaceHandle EmptyCore::getPublication(LocalFederateId /*federateID*/, const std::string& /*key*/) const
{
    return {};
}
...
InterfaceHandle EmptyCore::getEndpoint(LocalFederateId /*federateID*/, const std::string& /*name*/) const
{
    return {};
}
...
void EmptyCore::addSourceFilterToEndpoint(const std::string& /*filter*/, const std::string& /*endpoint*/)
{
...
void EmptyCore::sendAt(InterfaceHandle /*sourceHandle*/, const void* /*data*/, uint64_t /*length*/, Time /*time*/)
{
