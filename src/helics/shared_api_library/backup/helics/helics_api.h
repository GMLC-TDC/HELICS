...
const HelicsTime HELICS_TIME_BIGTIME = HELICS_BIG_NUMBER;
const HelicsTime HELICS_TIME_MAXTIME = HELICS_MAX_TIME_VALUE;
const HelicsTime HELICS_TIME_TERMINATION = HELICS_TERMINATION_TIME_VALUE;
