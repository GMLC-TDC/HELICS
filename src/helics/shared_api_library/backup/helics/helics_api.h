...
int32_t helicsIntToBytes(int64_t value, void* data, int datasize);
int32_t helicsDoubleToBytes(int64_t value, void* data, int datasize);
int32_t helicsStringToBytes(const char *str, void* data, int datasize);
...
HelicsBool helicsTranslatorIsValid(HelicsTranslator filt);
const char* helicsTranslatorGetName(HelicsTranslator filt);
void helicsTranslatorSet(HelicsTranslator filt, const char* prop, double val, HelicsError* err);
void helicsTranslatorSetString(HelicsTranslator filt, const char* prop, const char* val, HelicsError* err);
void helicsTranslatorAddDestinationTarget(HelicsTranslator filt, const char* dst, HelicsError* err);
void helicsTranslatorAddSourceTarget(HelicsTranslator filt, const char* source, HelicsError* err);
void helicsTranslatorRemoveTarget(HelicsTranslator filt, const char* target, HelicsError* err);
const char* helicsTranslatorGetInfo(HelicsTranslator filt);
void helicsTranslatorSetInfo(HelicsTranslator filt, const char* info, HelicsError* err);
const char* helicsTranslatorGetTag(HelicsTranslator filt, const char* tagname);
void helicsTranslatorSetTag(HelicsTranslator filt, const char* tagname, const char* tagvalue, HelicsError* err);
void helicsTranslatorSetOption(HelicsTranslator filt, int option, int value, HelicsError* err);
int helicsTranslatorGetOption(HelicsTranslator filt, int option);
