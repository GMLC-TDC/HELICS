...
@return a helics_status enumeration helics_ok on success helicsInvalidReference if fi is not a valid reference helics_discard if the string is not recognized
*/
...
HELICS_Export helics_status helicsFederateInfoSetFlag (helics_federate_info_t fi, int flag, int value);
...
*/
HELICS_Export helics_status helicsEnterInitializationMode (helics_federate fed);
...
*/
HELICS_Export helics_status helicsEnterInitializationModeAsync (helics_federate fed);
...
HELICS_Export helics_status helicsEnterInitializationModeComplete (helics_federate fed);
...
*/
HELICS_Export helics_status helicsEnterExecutionMode (helics_federate fed);
...
/ref 
*/
HELICS_Export helics_status helicsEnterExecutionModeAsync(helics_federate fed);

/** complete the call to /ref EnterExecutionModeAsync
@param fed the federate object to complete the call
*/
HELICS_Export helics_status helicsEnterExecutionModeComplete(helics_federate fed);

HELICS_Export helics_status helicsEnterExecutionModeIterative (helics_federate fed, iteration_request iterate, iteration_status *outIterate);
HELICS_Export helics_status helicsEnterExecutionModeIterativeAsync (helics_federate fed, iteration_request iterate);


HELICS_Export helics_status helicsEnterExecutionModeIterativeComplete (helics_federate fed, iteration_status *outIterate);
...
HELICS_Export helics_status helicsRequestTimeAsync (helics_federate fed, helics_time_t requestTime);
HELICS_Export helics_status helicsRequestTimeIterativeAsync (helics_federate fed, helics_time_t requestTime, iteration_request iterate);
...
*/
HELICS_Export helics_status helicsFederateSetLookAhead(helics_federate fed, helics_time_t lookAhead);
...
@param[in] lookAhead the look ahead time
*/
HELICS_Export helics_status helicsFederateSetImpactWindow(helics_federate fed, helics_time_t window);
...
*/
HELICS_Export helics_status helicsFederateSetFlag(helics_federate fed, int flag, int flagValue);
...
the return will be nullptr if fed or query is an invalid object
*/
HELICS_Export helics_status helicsExecuteQueryAsync(helics_federate fed, helics_query query);
