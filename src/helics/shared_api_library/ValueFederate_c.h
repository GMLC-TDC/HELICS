...
HELICS_Export helics_subscription helicsRegisterSubscription (helics_value_federate fedID,
                                                              const char *name,
                                                              const char *type,
                                                              const char *units);
HELICS_Export helics_subscription helicsRegisterTypeSubscription (helics_value_federate fedID,
                                                                  int type,
                                                                  const char *name,
                                                                  const char *units);

HELICS_Export helics_publication helicsRegisterPublication (helics_value_federate fedID,
                                                            const char *name,
                                                            const char *type,
                                                            const char *units);
HELICS_Export helics_publication helicsRegisterTypePublication (helics_value_federate fedID,
                                                                int type,
                                                                const char *name,
                                                                const char *units);

HELICS_Export helics_publication helicsRegisterGlobalPublication (helics_value_federate fedID,
                                                                  const char *name,
                                                                  const char *type,
                                                                  const char *units);
HELICS_Export helics_publication helicsRegisterGlobalTypePublication (helics_value_federate fedID,
                                                                      int type,
                                                                      const char *name,
                                                                      const char *units);
