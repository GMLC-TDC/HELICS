...
HELICS_Export helics_endpoint helicsRegisterEndpoint (helics_message_federate fedID,
                                                      const char *name,
                                                      const char *type);

HELICS_Export helics_endpoint helicsRegisterGlobalEndpoint (helics_message_federate fedID,
                                                            const char *name,
                                                            const char *type);
...
HELICS_Export int helicsFederateHasMessage (helics_message_federate fedID);
 ...
 */
HELICS_Export int helicsFederateReceiveCount (helics_message_federate fedID);
/**
...
HELICS_Export message_t helicsFederateGetMessage (helics_message_federate fedID);
