  ...
  */
  ...
  Publication registerPublication (const std::string &name, const std::string &type, const std::string &units = "")
  {
    helics_publication pub =
      helicsFederateRegisterTypePublication (fed, name.c_str (), type.c_str (), units.c_str (), hThrowOnError ());
    pubs.push_back (pub);
...
*/
  ...
  void publishJSON (const std::string &json) { helicsFederatePublishJSON (fed, json.c_str (), hThrowOnError ()); }
