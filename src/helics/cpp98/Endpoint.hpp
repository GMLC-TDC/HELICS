...
class Endpoint
{
  public:
    ...
    */
    ...
    {
        helicsEndpointSendMessageRaw (ep, dest.c_str (), data, static_cast<int> (data_size), hThrowOnError ());
    }
    /** send a data block and length
   @param data pointer to data location
   @param data_size the length of the data
   ...
   */
    ...
    */
    ...
    {
        helicsEndpointSendEventRaw (ep, dest.c_str (), data, static_cast<int> (data_size), time, hThrowOnError ());
    }
