...
namespace helicscpp {
/** object managing a translatorer in the C++98 interface*/
class Translator {
  public:
    ...
    /** check if the translatorer is valid */
    bool isValid() const { return (helicsTranslatorIsValid(translator) == HELICS_TRUE); }
    /** get the name for the translatorer*/
    const char* getName() const { return helicsTranslatorGetName(translator); }
    /** set a property on a translatorer
    @param property the name of the property of the translatorer to change
    ...
    */
    ...
    /** set a string property on a translatorer
   @param property the name of the property of the translatorer to change
   @param val the numerical value of the property
   */
    ...
    /** add a destination target to a cloning translatorer
    ...
    /** add a source target to a cloning translatorer
