...
- config file parsing was not acknowleging "unit" string #1512
- a performance issue with the tcpss core in some cases has been resolved by setting the no_delay option
