...
If you just want to get a HELICS co-simulation running on your local machine and to see how it works for yourself, this is the place to start. This Quick Start Guide will get HELICS installed along with the Python interface and the first fundamental example. You'll then be able to run it, see your results, and take a look at the code. And, of course, if at the end of all of that you're puzzled as to what you actually did, we have a [whole User Guide](../user-guide/index.md) to get you up to speed.
