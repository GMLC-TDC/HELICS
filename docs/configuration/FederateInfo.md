...
For a description of the available options see [Timing](./Timing) and  [helics_enums](https://helics.readthedocs.io/latest/doxygen/helics__enums_8h.html) and [helics_definitions](https://helics.readthedocs.io/latest/doxygen/helics__definitions_8hpp.html)
