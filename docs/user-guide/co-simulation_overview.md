...
A number of existing simulation tools have [already been integrated into HELICS](../referencesTools_using_HELICS.md) and can serve as good references when considering how an integration might be accomplished.
