...
- `HELICS_DISABLE_C_SHARED_LIB`: \[Default=OFF\] Turns off building of the HELICS C shared library. Probably very few use cases where a user/developer would want to turn this option ON.
