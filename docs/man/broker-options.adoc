...
--federates::
--minfederates <num>::
        The minimum total number of federates that will be connecting through
        the broker and any sub-brokers below it.

--required_federates <names>::
        A federate name or comma-separated list of federate names that must be
        registered before entering initialization mode.
...
--local_federates <num>::
        The minimum number of federates attached through direct child cores of
        this broker before entering initialization mode.

--local_subbrokers <num>::
        The minimum number of direct child brokers, excluding cores, before
