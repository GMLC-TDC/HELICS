...
'helics_broker' [-v|--version] [-h|-?|--help]
    [--quiet] [--config-file <file>] [-t|--core_type|--coreType|--coretype <type>]
    ...
    [--brokerKey|--brokerkey|--broker_key <key>] [--slowresponding|--slow_responding|--slowResponding]
    ...
    [--useosport|--use_os_port|useOsPort] [--autobroker] [--brokerinitstring <init str>]
    [--client|--server] [-p|--port <num>] [--brokerport <num>] [--localport <num>]
    [--portstart <num>] [--local_interface|--localinterface|--localInterface <network interface>] [--root]
    [--autorestart]
